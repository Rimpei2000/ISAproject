...
import { XhrIo as N, EventType as _, ErrorCode as A, createWebChannelTransport as k, getStatEventTarget as D, FetchXmlHttpFactory as x, WebChannel as C, Event as O, Stat as P } from "@firebase/webchannel-wrapper";
 ...
 * limitations under the License.
 */
var M = "9.6.7", V = new h("@firebase/firestore");
...
function U(t) {
    ...
    if (V.logLevel <= l.DEBUG) {
        var i = n.map(j);
        V.debug.apply(V, e([ "Firestore (" + M + "): " + t ], i));
    }
}

function B(t) {
    for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
    if (V.logLevel <= l.ERROR) {
        var i = n.map(j);
        V.error.apply(V, e([ "Firestore (" + M + "): " + t ], i));
    }
}
 ...
 */ function K(t) {
    for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
    if (V.logLevel <= l.WARN) {
        var i = n.map(j);
        V.warn.apply(V, e([ "Firestore (" + M + "): " + t ], i));
    }
}
 ...
 */ var H = {
    ...
    return t.prototype.start = function(t, e) {
        ...
        // request is outstanding.
            ...
            t.getToken()) : n ? (Q("string" == typeof n.accessToken), new X(n.accessToken, t.currentUser)) : null;
    ...
    t.prototype.u = function() {
        ...
        return Q(null === t || "string" == typeof t), new L(t);
    }, t;
}(), et = function(t, e, n) {
    ...
    return t.prototype.start = function(t, e) {
        ...
        return this.forceRefresh = !1, this.appCheck ? this.appCheck.getToken(e).then((function(e) {
            return e ? (Q("string" == typeof e.token), t.p = e.token, new rt(e.token)) : null;
        })) : Promise.resolve(null);
    }, t.prototype.invalidateToken = function() {
        this.forceRefresh = !0;
    }, t.prototype.shutdown = function() {
    ...
    switch (n) {
      ...
      case 3 /* TimestampValue */ :
        return function(t, e) {
            ...
            var n = Nt(t.timestampValue), r = Nt(e.timestampValue);
      ...
      case 9 /* ArrayValue */ :
        return ht(t.arrayValue.values || [], e.arrayValue.values || [], qt);
...
function Bt(t, e) {
    ...
    switch (n) {
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            var n = ct(_t(t.latitude), _t(e.latitude));
            return 0 !== n ? n : ct(_t(t.longitude), _t(e.longitude));
...
function Kt(t, e) {
    ...
    var n = Nt(t), r = Nt(e), i = ct(n.seconds, r.seconds);
...
var te = /** @class */ function() {
    ...
    return t.newInvalidDocument = function(e) {
        return new t(e, 0 /* INVALID */ , dt.min(), dt.min(), $t.empty(), 0 /* SYNCED */);
    }, 
    /**
    ...
    /** Creates a new document that is known to not exist at the given version. */ t.newNoDocument = function(e, n) {
        return new t(e, 2 /* NO_DOCUMENT */ , n, dt.min(), $t.empty(), 0 /* SYNCED */);
    }, 
    /**
    ...
    t.newUnknownDocument = function(e, n) {
        return new t(e, 3 /* UNKNOWN_DOCUMENT */ , n, dt.min(), $t.empty(), 2 /* HAS_COMMITTED_MUTATIONS */);
    }, 
    /**
 ...
 */
/** An ID for an index that has not yet been added to persistence.  */ ee.UNKNOWN_ID = -1;
...
e) {
    ...
    return t.min = function() {
        return new t(dt.min(), Mt.empty(), -1);
    }, t;
}(), oe = function(t, e, n, r, i, o, s) {
...
var he = /** @class */ function(e) {
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.v(t, e, r) : new le(t, e, r) : "array-contains" /* ARRAY_CONTAINS */ === e ? new ye(t, r) : "in" /* IN */ === e ? new ve(t, r) : "not-in" /* NOT_IN */ === e ? new me(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new ge(t, r) : new n(t, e, r);
    }, n.v = function(t, e, n) {
        return "in" /* IN */ === e ? new fe(t, n) : new de(t, n);
    }, n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.V(Bt(e, this.value)) : null !== e && Ft(this.value) === Ft(e) && this.V(Bt(e, this.value));
...
}(he), fe = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, "in" /* IN */ , n) || this).keys = pe("in" /* IN */ , n), 
        r;
    }
    return t(n, e), n.prototype.matches = function(t) {
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t, "not-in" /* NOT_IN */ , n) || this).keys = pe("not-in" /* NOT_IN */ , n), 
        r;
    }
    return t(n, e), n.prototype.matches = function(t) {
        return !this.keys.some((function(e) {
...
/** A Filter that implements the array-contains operator. */ var ye = /** @class */ function(e) {
    function n(t, n) {
        return e.call(this, t, "array-contains" /* ARRAY_CONTAINS */ , n) || this;
    }
    return t(n, e), n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        return Wt(e) && Ut(e.arrayValue, this.value);
    }, n;
}(he), ve = /** @class */ function(e) {
    function n(t, n) {
...
function Te(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.isKeyField() ? Mt.comparator(Mt.fromName(s.referenceValue), n.key) : Bt(s, n.data.field(o.field)), 
 ...
 */ function Oe(t) {
    ...
    if (null === e.D) {
        ...
        n.isKeyField() || e.D.push(new be(n)), e.D.push(new be(bt.keyField(), "asc" /* ASCENDING */)); else {
 ...
 */ function Pe(t) {
    var e = W(t);
    if (!e.C) if ("F" /* First */ === e.limitType) e.C = se(e.path, e.collectionGroup, Oe(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        // Flip the orderBy directions since we want the last results
        var n = [], r = 0, i = Oe(e); r < i.length; r++) {
            var o = i[r], s = "desc" /* DESCENDING */ === o.dir ? "asc" /* ASCENDING */ : "desc" /* DESCENDING */;
            n.push(new be(o.field, s));
        }
        // We need to swap the cursors to match the now-flipped query ordering.
                var u = e.endAt ? new we(e.endAt.position, !e.endAt.inclusive) : null, a = e.startAt ? new we(e.startAt.position, !e.startAt.inclusive) : null;
        // Now return as a LimitType.First query.
                e.C = se(e.path, e.collectionGroup, n, e.filters, e.limit, u, a);
    }
    return e.C;
}
...
function Le(t, e) {
    return ae(Pe(t), Pe(e)) && t.limitType === e.limitType;
}
 ...
 */
        ...
        }(t.startAt, Oe(t), e)) && !(t.endAt && !function(t, e, n) {
            var r = Te(t, e, n);
            return t.inclusive ? r >= 0 : r > 0;
        }(t.endAt, Oe(t), e));
    }(t, e);
 ...
 */ function Qe(t, e, n) {
    ...
    }(n, e) : t instanceof Ye ? Je(t, e) : t instanceof Xe ? $e(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        var n = We(t, e), r = tn(n) + tn(t.k);
        return zt(n) && zt(t.k) ? Ke(r) : Be(t.O, r);
    }(t, e);
}
 ...
 */ function ze(t, e, n) {
    ...
    // applications.
    return t instanceof Ye ? Je(t, e) : t instanceof Xe ? $e(t, e) : n;
}
 ...
 */ function We(t, e) {
    return t instanceof Ze ? zt(n = e) || function(t) {
 ...
 */ var Ze = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).O = t, r.k = n, r;
    }
    return t(n, e), n;
}(Ge);
 ...
 * limitations under the License.
 */
/** A field path and the TransformOperation to perform upon it. */ var nn = function(t, e) {
 ...
 */ function an(t, e, n) {
    t instanceof dn ? function(t, e, n) {
 ...
 */ function cn(t, e, n) {
    t instanceof dn ? function(t, e, n) {
        if (sn(t.precondition, e)) {
            ...
            r.setAll(i), e.convertToFoundDocument(fn(e), r).setHasLocalMutations();
        }
    }(t, e, n) : t instanceof pn ? function(t, e, n) {
        if (sn(t.precondition, e)) {
            var r = mn(t.fieldTransforms, n, e), i = e.data;
            i.setAll(yn(t)), i.setAll(r), e.convertToFoundDocument(fn(e), i).setHasLocalMutations();
        }
    }(t, e, n) : function(t, e) {
        sn(t.precondition, e) && 
 ...
 */ function hn(t, e) {
    for (var n = null, r = 0, i = t.fieldTransforms; r < i.length; r++) {
        var o = i[r], s = e.data.field(o.field), u = We(o.transform, s || null);
        null != u && (null == n && (n = $t.empty()), n.set(o.field, u));
    }
    return n || null;
}
        ...
        return void 0 === t && void 0 === e || !(!t || !e) && ht(t, e, (function(t, e) {
            return function(t, e) {
                return t.field.isEqual(e.field) && function(t, e) {
                    return t instanceof Ye && e instanceof Ye || t instanceof Xe && e instanceof Xe ? ht(t.elements, e.elements, qt) : t instanceof Ze && e instanceof Ze ? qt(t.k, e.k) : t instanceof He && e instanceof He;
...
/** A mutation that deletes the document at the given key. */ var gn, wn, bn = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
 ...
 */ function Sn(t) {
    ...
    switch (t) {
      ...
      case gn.DEADLINE_EXCEEDED:
        return H.DEADLINE_EXCEEDED;

      case gn.RESOURCE_EXHAUSTED:
      ...
      case gn.INVALID_ARGUMENT:
        return H.INVALID_ARGUMENT;

      case gn.NOT_FOUND:
        return H.NOT_FOUND;

      case gn.ALREADY_EXISTS:
        return H.ALREADY_EXISTS;

      case gn.PERMISSION_DENIED:
        return H.PERMISSION_DENIED;

      case gn.FAILED_PRECONDITION:
        return H.FAILED_PRECONDITION;

      case gn.ABORTED:
        return H.ABORTED;

      case gn.OUT_OF_RANGE:
 ...
 *     Code.UNKNOWN.
 */ (wn = gn || (gn = {}))[wn.OK = 0] = "OK", wn[wn.CANCELLED = 1] = "CANCELLED", 
...
var Nn = /** @class */ function() {
    ...
    // Returns a copy of the map, with the specified key/value added or replaced.
        ...
        return new t(this.comparator, this.root.insert(e, n, this.comparator).copy(null, null, An.BLACK, null, null));
    }, 
    // Returns a copy of the map, with the specified key removed.
    t.prototype.remove = function(e) {
        return new t(this.comparator, this.root.remove(e, this.comparator).copy(null, null, An.BLACK, null, null));
    }, 
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var Cn = new Nn(Mt.comparator);

function On() {
    return Cn;
}

var Pn = new Nn(Mt.comparator);

function Rn() {
    return Pn;
}

var Ln = new Nn(Mt.comparator), Mn = new kn(Mt.comparator);

function Vn() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    for (var n = Mn, r = 0, i = t; r < i.length; r++) {
        var o = i[r];
        n = n.add(o);
    }
    return n;
 ...
 */ var Un = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, Bn.createSynthesizedTargetChangeForCurrentChange(e, n)), new t(dt.min(), r, qn(), On(), Vn());
    }, t;
}(), Bn = /** @class */ function() {
    function t(
    /**
    ...
    return t.createSynthesizedTargetChangeForCurrentChange = function(e, n) {
        return new t(Et.EMPTY_BYTE_STRING, n, Vn(), Vn(), Vn());
    }, t;
}(), Kn = function(
...
/**
     ...
     */
r) {
    this.M = t, this.removedTargetIds = e, this.key = n, this.$ = r;
}, jn = function(t, e) {
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    return t.prototype.ct = function(t) {
        for (var e = 0, n = t.M; e < n.length; e++) {
            var r = n[e];
            t.$ && t.$.isFoundDocument() ? this.ut(r, t.$) : this.at(r, t.key, t.$);
        }
    ...
    t.prototype._t = function(t) {
        ...
        if (r) {
            ...
            if (ce(i)) if (0 === n) {
                ...
                // queries.
                var o = new Mt(i.path);
                this.at(e, o, te.newNoDocument(o, dt.min()));
            } else Q(1 === n); else this.gt(e) !== n && (
    ...
    t.prototype.yt = function(t) {
        ...
        this.st.forEach((function(r, i) {
            ...
            if (o) {
                if (r.current && ce(o.target)) {
                    ...
                    null !== e.it.get(s) || e.It(i, s) || e.at(i, s, te.newNoDocument(s, t));
                }
                r.j && (n.set(i, r.H()), r.J());
            }
        }));
        ...
        var i = new Un(t, n, this.ot, this.it, r);
        return this.it = On(), this.rt = Wn(), this.ot = new kn(ct), i;
    }, 
    /**
    ...
    t.prototype.at = function(t, e, n) {
        if (this.ft(t)) {
            ...
            r.X(e), this.rt = this.rt.insert(e, this.Et(e).delete(t)), n && (this.it = this.it.insert(e, n));
        }
    ...
    t.prototype.Z = function(t) {
        ...
        var e = this.st.get(t);
        return e || (e = new Qn, this.st.set(t, e)), e;
    }, t.prototype.Et = function(t) {
        var e = this.rt.get(t);
        return e || (e = new kn(ct), this.rt = this.rt.insert(t, e)), e;
    }, 
    /**
    ...
    t.prototype.dt = function(t) {
        var e = this;
        this.st.set(t, new Qn), this.nt.getRemoteKeysForTarget(t).forEach((function(n) {
 ...
 */ function tr(t, e) {
    return $n(t, e.toTimestamp());
}

function er(t) {
    return Q(!!t), dt.fromTimestamp(function(t) {
        var e = Nt(t);
        return new ft(e.seconds, e.nanos);
    }(t));
}
...
function ur(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? gt.emptyPath() : cr(e);
}
...
function lr(t, e, n) {
    var r = or(t, e.name), i = er(e.updateTime), o = new $t({
        mapValue: {
            fields: e.fields
        }
    }), s = te.newFoundDocument(r, i, o);
...
function fr(t, e) {
    ...
    if (e instanceof dn) n = {
        update: hr(t, e.key, e.value)
    }; else if (e instanceof bn) n = {
        delete: ir(t, e.key)
    }; else if (e instanceof pn) n = {
        update: hr(t, e.key, e.data),
        updateMask: Sr(e.fieldMask)
    }; else {
        if (!(e instanceof In)) return G();
        n = {
            verify: ir(t, e.key)
        };
    }
...
function dr(t, e) {
    var n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? on.updateTime(er(t.updateTime)) : void 0 !== t.exists ? on.exists(t.exists) : on.none();
    }(e.currentDocument) : on.none(), r = e.updateTransforms ? e.updateTransforms.map((function(e) {
        return function(t, e) {
            var n = null;
            if ("setToServerValue" in e) Q("REQUEST_TIME" === e.setToServerValue), n = new He; else if ("appendMissingElements" in e) {
    ...
    if (e.update) {
        e.update.name;
        var i = or(t, e.update.name), o = new $t({
            mapValue: {
        ...
        if (e.updateMask) {
            ...
            return new pn(i, o, s, n, r);
        }
        return new dn(i, o, n, r);
    }
    if (e.delete) {
        var u = or(t, e.delete);
        return new bn(u, n);
...
function yr(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = sr(t, r), n.structuredQuery.from = [ {
        collectionId: e.collectionGroup,
        allDescendants: !0
    } ]) : (n.parent = sr(t, r.popLast()), n.structuredQuery.from = [ {
...
function vr(t) {
    ...
    var s = [];
    n.where && (s = mr(n.where));
    var u = [];
    n.orderBy && (u = n.orderBy.map((function(t) {
        return function(t) {
            return new be(Ir(t.field), 
            // visible for testing
            function(t) {
                switch (t) {
                  case "ASCENDING":
    ...
    var h = null;
    return n.endAt && (h = function(t) {
        var e = !t.before, n = t.values || [];
        return new we(n, e);
    }(n.endAt)), Ne(e, i, u, s, a, "F" /* First */ , c, h);
}
...
function Tr(t) {
    return he.create(Ir(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
...
function Er(t) {
    switch (t.unaryFilter.op) {
      case "IS_NAN":
        var e = Ir(t.unaryFilter.field);
        return he.create(e, "==" /* EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NULL":
        var n = Ir(t.unaryFilter.field);
        return he.create(n, "==" /* EQUAL */ , {
            nullValue: "NULL_VALUE"
        });

      case "IS_NOT_NAN":
        var r = Ir(t.unaryFilter.field);
        return he.create(r, "!=" /* NOT_EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NOT_NULL":
        var i = Ir(t.unaryFilter.field);
        return he.create(i, "!=" /* NOT_EQUAL */ , {
            nullValue: "NULL_VALUE"
        });
 ...
 */ function _r(t) {
    for (var e = "", n = 0; n < t.length; n++) e.length > 0 && (e = kr(e)), e = Ar(t.get(n), e);
    return kr(e);
}
 ...
 */ function Dr(t) {
    ...
    var e = t.length;
    if (Q(e >= 2), 2 === e) return Q("" === t.charAt(0) && "" === t.charAt(1)), gt.emptyPath();
...
/** Name of the IndexedDb object store.  */ Or.store = "mutationQueues", 
...
/** Name of the IndexedDb object store.  */ Pr.store = "mutations", 
/** Keys are automatically assigned via the userId, batchId properties. */
Pr.keyPath = "batchId", 
/** The index name for lookup of mutations by user. */
Pr.userMutationsIndex = "userMutationsIndex", 
/** The user mutations index is keyed by [userId, batchId] pairs. */
Pr.userMutationsKeyPath = [ "userId", "batchId" ];
...
/** Name of the IndexedDb object store. */ Kr.store = "collectionParents", 
/** Keys are automatically assigned via the collectionId, parent properties. */
Kr.keyPath = [ "collectionId", "parent" ];
...
/** Name of the IndexedDb object store. */ Gr.store = "bundles", Gr.keyPath = "bundleId";
...
/** Name of the IndexedDb object store. */ zr.store = "indexConfiguration", zr.keyPath = "indexId", 
/**
     ...
     */
zr.collectionGroupIndex = "collectionGroupIndex", zr.collectionGroupIndexPath = "collectionGroup";
...
/**
     ...
     */
o) {
    this.indexId = t, this.uid = e, this.sequenceNumber = n, this.readTime = r, this.documentKey = i, 
    this.largestBatchId = o;
};

/** Name of the IndexedDb object store. */ Wr.store = "indexState", Wr.keyPath = [ "indexId", "uid" ], 
/**
     ...
     * persistence via multi-tab.
     */
Wr.sequenceNumberIndex = "sequenceNumberIndex", Wr.sequenceNumberIndexPath = [ "uid", "sequenceNumber" ];
...
i) {
    this.indexId = t, this.uid = e, this.arrayValue = n, this.directionalValue = r, 
    this.documentKey = i;
};

/** Name of the IndexedDb object store. */ Hr.store = "indexEntries", Hr.keyPath = [ "indexId", "uid", "arrayValue", "directionalValue", "documentKey" ], 
Hr.documentKeyIndex = "documentKeyIndex", Hr.documentKeyIndexPath = [ "indexId", "uid", "documentKey" ];
...
o) {
    this.userId = t, this.collectionPath = e, this.documentId = n, this.collectionGroup = r, 
    this.largestBatchId = i, this.overlayMutation = o;
};

/** Name of the IndexedDb object store. */ Yr.store = "documentOverlays", Yr.keyPath = [ "userId", "collectionPath", "documentId" ], 
Yr.collectionPathOverlayIndex = "collectionPathOverlayIndex", Yr.collectionPathOverlayIndexPath = [ "userId", "collectionPath", "largestBatchId" ], 
Yr.collectionGroupOverlayIndex = "collectionGroupOverlayIndex", Yr.collectionGroupOverlayIndexPath = [ "userId", "collectionGroup", "largestBatchId" ];

// Visible for testing
var Jr = e(e([], e(e([], e(e([], e(e([], [ Or.store, Pr.store, Rr.store, Vr.store, qr.store, Cr.store, Br.store, Ur.store ]), [ jr.store ])), [ Fr.store ])), [ Kr.store ])), [ Gr.store, Qr.store ]), Xr = e(e([], Jr), [ Yr.store ]), $r = e(e([], Xr), [ zr.store, Wr.store, Hr.store ]), Zr = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", ti = /** @class */ function() {
    function t() {
    ...
    function t(t, e) {
        ...
        this.At = new J, this.transaction.oncomplete = function() {
            ...
            e.error ? n.At.reject(new oi(t, e.error)) : n.At.resolve();
        }, this.transaction.onerror = function(e) {
            var r = hi(e.target.error);
            n.At.reject(new oi(t, r));
        };
    }
    ...
    /** Deletes the specified database. */    return t.delete = function(t) {
        return U("SimpleDb", "Removing database:", t), ai(window.indexedDB.deleteDatabase(t)).toPromise();
    }, 
    ...
    /** Helper to get a typed SimpleDbStore from a transaction. */ t.Nt = function(t, e) {
        return t.store(e);
    }, 
    // visible for testing
    ...
    t.prototype.xt = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 2:
                    return [ 2 /*return*/ , (this.Ot && (this.db.onversionchange = function(t) {
                        return n.Ot(t);
                    }), this.db) ];
                }
            }));
        ...
        this.Ot = t, this.db && (this.db.onversionchange = function(e) {
            return t(e);
        });
                    ...
                    n = "readonly" === e, s = 0, u = function() {
                        ...
                        return r(this, (function(r) {
                            switch (r.label) {
                              ...
                              case 1:
                                return r.trys.push([ 1, 4, , 5 ]), [ 4 /*yield*/ , a.xt(t) ];

                              case 2:
                                // Wait for the transaction to complete (i.e. IndexedDb's onsuccess event to
                                // fire), but still return the original transactionFnResult back to the
                                // caller.
                                return a.db = r.sent(), e = ni.open(a.db, t, n ? "readonly" : "readwrite", i), u = o(e).next((function(t) {
                                    return e.Pt(), t;
                                })).catch((function(t) {
                                    // Abort the transaction if there was an error.
                                    return e.abort(t), ei.reject(t);
                              ...
                              case 4:
                                return h = r.sent(), l = "FirebaseError" !== h.name && s < 3, U("SimpleDb", "Transaction failed with error:", h.message, "Retrying:", l), 
                                a.close(), l ? [ 3 /*break*/ , 5 ] : [ 2 /*return*/ , {
 ...
 * limitations under the License.
 */
/** Verifies whether `e` is an IndexedDbTransactionError. */ function si(t) {
 ...
 */ var ui = /** @class */ function() {
    ...
    t.prototype.add = function(t) {
        return U("SimpleDb", "ADD", this.store.name, t, t), ai(this.store.add(t));
    }, 
    /**
    ...
    t.prototype.get = function(t) {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
                return ai(this.store.get(t)).next((function(n) {
            // Normalize nonexistence to null.
            return void 0 === n && (n = null), U("SimpleDb", "GET", e.store.name, t, n), n;
        }));
    }, t.prototype.delete = function(t) {
        return U("SimpleDb", "DELETE", this.store.name, t), ai(this.store.delete(t));
    }, 
    /**
    ...
    t.prototype.count = function() {
        return U("SimpleDb", "COUNT", this.store.name), ai(this.store.count());
    ...
    t.prototype.Wt = function(t) {
        var e = this.cursor({});
        return new ei((function(n, r) {
            e.onerror = function(t) {
                var e = hi(t.target.error);
                r(e);
        ...
        var n = [];
        return new ei((function(r, i) {
            t.onerror = function(t) {
                i(t.target.error);
            }, t.onsuccess = function(t) {
                var i = t.target.result;
                if (i) {
                    var o = new ii(i), s = e(i.primaryKey, i.value, o);
                    if (s instanceof ei) {
                        var u = s.catch((function(t) {
                            return o.done(), ei.reject(t);
                        }));
                        n.push(u);
                    }
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var li = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).zt = t, r.currentSequenceNumber = n, r;
    }
    return t(n, e), n;
}(ti);
 ...
 */ var di = /** @class */ function() {
    ...
    return t.prototype.applyToRemoteDocument = function(t, e) {
        for (var n = e.mutationResults, r = 0; r < this.mutations.length; r++) {
            ...
            i.key.isEqual(t.key) && an(i, t, n[r]);
        }
    }, 
    /**
    ...
    t.prototype.applyToLocalView = function(t) {
        ...
        for (var e = 0, n = this.baseMutations; e < n.length; e++) {
            var r = n[e];
            r.key.isEqual(t.key) && cn(r, t, this.localWriteTime);
        }
        // Second, apply all user-provided mutations.
                for (var i = 0, o = this.mutations; i < o.length; i++) {
            var s = o[i];
            s.key.isEqual(t.key) && cn(s, t, this.localWriteTime);
        }
    }, 
    /**
...
/** Decodes a remote document from storage locally to a Document. */ function gi(t, e) {
    var n;
    if (e.document) n = lr(t.Ht, e.document, !!e.hasCommittedMutations); else if (e.noDocument) {
        var r = Mt.fromSegments(e.noDocument.path), i = Ei(e.noDocument.readTime);
        n = te.newNoDocument(r, i), e.hasCommittedMutations && n.setHasCommittedMutations();
    } else {
        if (!e.unknownDocument) return G();
        var o = Mt.fromSegments(e.unknownDocument.path), s = Ei(e.unknownDocument.version);
        n = te.newUnknownDocument(o, s);
    }
    return e.readTime && n.setReadTime(Ii(e.readTime)), n
    /** Encodes a document for storage locally. */;
}

function wi(t, e) {
    var n = bi(e.readTime), r = e.key.path.popLast().toArray();
    if (e.isFoundDocument()) {
        var i = function(t, e) {
            return {
                name: ir(t, e.key),
                fields: e.data.value.mapValue.fields,
                updateTime: $n(t, e.version.toTimestamp())
            };
        }(t.Ht, e), o = e.hasCommittedMutations;
        return new Vr(
        /* unknownDocument= */ null, 
        /* noDocument= */ null, i, o, n, r);
    }
    if (e.isNoDocument()) {
        var s = e.key.path.toArray(), u = Ti(e.version), a = e.hasCommittedMutations;
        return new Vr(
        /* unknownDocument= */ null, new Lr(s, u), 
        /* document= */ null, a, n, r);
    }
    if (e.isUnknownDocument()) {
        var c = e.key.path.toArray(), h = Ti(e.version);
        return new Vr(new Mr(c, h), 
        /* noDocument= */ null, 
        /* document= */ null, 
...
function Ti(t) {
    var e = t.toTimestamp();
    return new xr(e.seconds, e.nanoseconds);
}
...
/** Decodes a DbMutationBatch into a MutationBatch */ function Si(t, e) {
    ...
    return new di(e.batchId, u, n, s);
}

/** Decodes a DbTarget into TargetData */ function Ni(t) {
    var e, n, r = Ei(t.readTime), i = void 0 !== t.lastLimboFreeSnapshotVersion ? Ei(t.lastLimboFreeSnapshotVersion) : dt.min();
    return void 0 !== t.query.documents ? (Q(1 === (n = t.query).documents.length), 
    e = Pe(_e(ur(n.documents[0])))) : e = function(t) {
        return Pe(vr(t));
    }(t.query), new vi(e, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, r, i, Et.fromBase64String(t.resumeToken))
    /** Encodes TargetData into a DbTarget for storage locally. */;
}

function _i(t, e) {
    var n, r = Ti(e.snapshotVersion), i = Ti(e.lastLimboFreeSnapshotVersion);
    n = ce(e.target) ? pr(t.Ht, e.target) : yr(t.Ht, e.target);
    // We can't store the resumeToken as a ByteString in IndexedDb, so we
    // convert it to a base64 string for storage.
    var o = e.resumeToken.toBase64();
    // lastListenSequenceNumber is always 0 until we do real GC.
        return new qr(e.targetId, ue(e.target), r, o, e.sequenceNumber, i, n);
}
...
/** Encodes a DbDocumentOverlay object to an Overlay model object. */ function ki(t, e) {
    return new yi(e.largestBatchId, dr(t.Ht, e.overlayMutation));
}
 ...
 */ function Ci(t) {
    return fi(t, Gr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the namedQueries object store.
 */ function Oi(t) {
    return fi(t, Qr.store);
}
 ...
 */ var Pi = /** @class */ function() {
    ...
    return t.Jt = function(e, n) {
        ...
        var n = this;
        return Ri(t).get(Di(this.userId, e)).next((function(t) {
            return t ? ki(n.O, t) : null;
        }));
        ...
        e.forEach((function(t) {
            return i.add(_r(t.getCollectionPath()));
        }));
        var o = [];
        return i.forEach((function(e) {
            ...
            /*lowerOpen=*/ !1, 
            /*upperOpen=*/ !0);
            o.push(Ri(t).Gt(Yr.collectionPathOverlayIndex, i));
        })), ei.waitFor(o);
    }, t.prototype.getOverlaysForCollection = function(t, e, n) {
        var r = this, i = new Map, o = _r(e), s = IDBKeyRange.bound([ this.userId, o, n ], [ this.userId, o, Number.POSITIVE_INFINITY ], 
        /*lowerOpen=*/ !0);
        return Ri(t).qt(Yr.collectionPathOverlayIndex, s).next((function(t) {
            for (var e = 0, n = t; e < n.length; e++) {
                var o = n[e], s = ki(r.O, o);
                i.set(s.getKey(), s);
            }
            return i;
        }));
    }, t.prototype.getOverlaysForCollectionGroup = function(t, e, n, r) {
        var i, o = this, s = new Map, u = IDBKeyRange.bound([ this.userId, e, n ], [ this.userId, e, Number.POSITIVE_INFINITY ], 
        /*lowerOpen=*/ !0);
        return Ri(t).Qt({
            index: Yr.collectionGroupOverlayIndex,
            range: u
        }, (function(t, e, n) {
        ...
        return Ri(t).put(function(t, e, n) {
            var r = Di(e, n.mutation.key);
            r[0];
            var i = r[1], o = r[2];
            return new Yr(e, i, o, n.mutation.key.getCollectionGroup(), n.largestBatchId, fr(t.Ht, n.mutation));
...
/** Firestore index value writer.  */ var Li = /** @class */ function() {
    function t() {}
    ...
    /** Writes an index value.  */    return t.prototype.Xt = function(t, e) {
        this.Zt(t, e), 
        ...
        e.ne(t.booleanValue ? 1 : 0); else if ("integerValue" in t) this.ee(e, 15), e.ne(_t(t.integerValue)); else if ("doubleValue" in t) {
            var n = _t(t.doubleValue);
            isNaN(n) ? this.ee(e, 13) : (this.ee(e, 15), Rt(n) ? 
            // -0.0, 0 and 0.0 are all considered the same
            e.ne(0) : e.ne(n));
        } else if ("timestampValue" in t) {
            var r = t.timestampValue;
            this.ee(e, 20), "string" == typeof r ? e.se(r) : (e.se("" + (r.seconds || "")), 
            e.ne(r.nanos || 0));
        ...
        e.oe(At(t.bytesValue)), this.re(e); else if ("referenceValue" in t) this.ce(t.referenceValue, e); else if ("geoPointValue" in t) {
            ...
            this.ee(e, 45), e.ne(i.latitude || 0), e.ne(i.longitude || 0);
        } else "mapValue" in t ? qt(t, Vt) ? this.ee(e, Number.MAX_SAFE_INTEGER) : (this.ue(t.mapValue, e), 
        this.re(e)) : "arrayValue" in t ? (this.ae(t.arrayValue, e), this.re(e)) : G();
        ...
        var n = this;
        this.ee(e, 37), Mt.fromName(t).path.forEach((function(t) {
            n.ee(e, 60), n.he(t, e);
        }));
...
var Fi = /** @class */ function() {
    ...
    return t.prototype.fe = function(t) {
        ...
        for (var e = t[Symbol.iterator](), n = e.next(); !n.done; ) this.me(n.value), n = e.next();
        this.ge();
    }, 
    /** Writes utf8 bytes into this byte sequence, ascending. */ t.prototype.ye = function(t) {
        for (var e = 0, n = t; e < n.length; e++) {
    ...
    /** Writes utf8 bytes into this byte sequence, descending */ t.prototype.pe = function(t) {
        for (var e = 0, n = t; e < n.length; e++) {
            var r = n[e], i = r.charCodeAt(0);
            if (i < 128) this.me(i); else if (i < 2048) this.me(960 | i >>> 6), this.me(128 | 63 & i); else if (r < "\ud800" || "\udbff" < r) this.me(480 | i >>> 12), 
            this.me(128 | 63 & i >>> 6), this.me(128 | 63 & i); else {
                var o = r.codePointAt(0);
                this.me(240 | o >>> 18), this.me(128 | 63 & o >>> 12), this.me(128 | 63 & o >>> 6), 
                this.me(128 | 63 & o);
            }
        }
        this.ge();
    ...
    /** Makes a copy of the encoded bytes in this buffer.  */ t.prototype.Ve = function() {
    ...
    /** Writes a single byte descending to the buffer.  */ t.prototype.me = function(t) {
        var e = 255 & t;
    ...
    function t() {
        this.Se = new Fi, this.De = new qi(this.Se), this.Ce = new Ui(this.Se);
    }
...
function ji(t, e) {
    ...
    return 0 !== n ? n : 0 !== (n = Mt.comparator(t.documentKey, e.documentKey)) ? n : 0 !== (n = Gi(t.arrayValue, e.arrayValue)) ? n : Gi(t.directionalValue, e.directionalValue);
}
 ...
 */ var Qi = /** @class */ function() {
    ...
    return t.prototype.addToCollectionParentIndex = function(t, e) {
        return this.xe.add(e), ei.resolve();
    }, t.prototype.getCollectionParents = function(t, e) {
        return ei.resolve(this.xe.getEntries(e));
        ...
        // Field indices are not supported with memory persistence.
        return ei.resolve();
    }, t.prototype.getDocumentsMatchingTarget = function(t, e, n) {
        // Field indices are not supported with memory persistence.
        return ei.resolve(Vn());
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e] || new kn(gt.comparator), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new kn(gt.comparator)).toArray();
    }, t;
}(), Wi = /** @class */ function() {
    function t(t) {
        this.user = t, 
    ...
    return t.prototype.addToCollectionParentIndex = function(t, e) {
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return Hi(t).qt(r).next((function(t) {
        ...
        // Safari & Firefox.
        var n = Ji(t), r = function(t) {
            return new zr(t.indexId, t.collectionGroup, t.fields.map((function(t) {
    ...
    t.prototype.Oe = function(t, e) {
        for (var n = new Bi, r = 0, i = function(t) {
    ...
    /** Encodes a single value to the ascending index format. */ t.prototype.Me = function(t) {
        var e = new Bi;
        return Li.le.Xt(t, e.Ne(0 /* ASCENDING */)), e.Ve();
    }, t.prototype.getFieldIndexes = function(t, e) {
        var n = this, r = Ji(t), i = Xi(t);
        return (e ? r.qt(zr.collectionGroupIndex, IDBKeyRange.bound(e, e)) : r.qt()).next((function(t) {
            var e = [];
            return ei.forEach(t, (function(t) {
                return i.get([ t.indexId, n.uid ]).next((function(n) {
                    e.push(function(t, e) {
                        var n = e ? new re(e.sequenceNumber, new ie(Ei(e.readTime), new Mt(Dr(e.documentKey)), e.largestBatchId)) : re.empty(), r = t.fields.map((function(t) {
                            var e = t[0], n = t[1];
                            return new ne(bt.fromServerFormat(e), n);
                        }));
                        return new ee(t.indexId, t.collectionGroup, r, n);
                    }(t, n));
                }));
            })).next((function() {
                return e;
        ...
        return this.getFieldIndexes(t).next((function(t) {
            return 0 === t.length ? null : (t.sort((function(t, e) {
                return t.indexState.sequenceNumber - e.indexState.sequenceNumber;
            })), t[0].collectionGroup);
        }));
    }, t.prototype.updateCollectionGroup = function(t, e, n) {
        var r = this, i = Ji(t), o = Xi(t);
        return this.$e(t).next((function(t) {
            return i.qt(zr.collectionGroupIndex, IDBKeyRange.bound(e, e)).next((function(e) {
                return ei.forEach(e, (function(e) {
                    return o.put(function(t, e, n, r) {
                        return new Wr(t, e.uid || "", n, Ti(r.readTime), _r(r.documentKey.path), r.largestBatchId);
        ...
        // here.
                return ei.forEach(e, (function(e, i) {
            var o = r.get(e.collectionGroup);
            return (o ? ei.resolve(o) : n.getFieldIndexes(t, e.collectionGroup)).next((function(o) {
                return r.set(e.collectionGroup, o), ei.forEach(o, (function(r) {
                    return n.Fe(t, e, r).next((function(e) {
                        var o = n.Be(i, r);
                        return e.isEqual(o) ? ei.resolve() : n.Le(t, i, e, o);
                    }));
                }));
            }));
        }));
    }, t.prototype.Ue = function(t, e, n) {
        return Yi(t).put(new Hr(n.indexId, this.uid, n.arrayValue, n.directionalValue, _r(e.key.path)));
    }, t.prototype.qe = function(t, e, n) {
        return Yi(t).delete([ n.indexId, this.uid, n.arrayValue, n.directionalValue, _r(e.key.path) ]);
    }, t.prototype.Fe = function(t, e, n) {
        var r = Yi(t), i = new kn(ji);
        return r.Qt({
            index: Hr.documentKeyIndex,
            range: IDBKeyRange.only([ n.indexId, this.uid, _r(e.path) ])
        }, (function(t, r) {
            i = i.add(new Ki(n.indexId, e, r.arrayValue, r.directionalValue));
        })).next((function() {
            return i;
        }));
    }, 
    /** Creates the index entries for the given document. */ t.prototype.Be = function(t, e) {
        var n = new kn(ji), r = this.Oe(e, t);
        if (null == r) return n;
        var i = 
        ...
        if (null != i) {
            ...
            if (Wt(o)) for (var s = 0, u = o.arrayValue.values || []; s < u.length; s++) {
                var a = u[s];
                n = n.add(new Ki(e.indexId, t.key, this.Me(a), r));
            }
        } else n = n.add(new Ki(e.indexId, t.key, new Uint8Array, r));
        return n;
    }, 
    /**
     ...
     * entries.
     */
    t.prototype.Le = function(t, e, n, r) {
        var i = this;
        ...
        return function(t, e, n, r, i) {
            ...
            // `comparator`.
            for (var o = t.getIterator(), s = e.getIterator(), u = xn(o), a = xn(s); u || a; ) {
                var c = !1, h = !1;
                if (u && a) {
                    var l = n(u, a);
                    l < 0 ? 
                ...
                c ? (r(a), a = xn(s)) : h ? (i(u), u = xn(o)) : (u = xn(o), a = xn(s));
            }
        }(n, r, ji, (
        /* onAdd= */ function(n) {
            o.push(i.Ue(t, e, n));
 ...
 */
function Hi(t) {
    return fi(t, Kr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the index entry object store.
 */ function Yi(t) {
    return fi(t, Hr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the index configuration object store.
 */ function Ji(t) {
    return fi(t, zr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the index state object store.
 */ function Xi(t) {
    return fi(t, Wr.store);
}
 ...
 */
function to(t, e, n) {
    var r = t.store(Pr.store), i = t.store(Rr.store), o = [], s = IDBKeyRange.only(n.batchId), u = 0, a = r.Qt({
        range: s
    }, (function(t, e, n) {
        return u++, n.delete();
    }));
    ...
    for (var c = [], h = 0, l = n.mutations; h < l.length; h++) {
        var f = l[h], d = Rr.key(e, f.key.path, n.batchId);
        o.push(i.delete(d)), c.push(f.key);
    }
    return ei.waitFor(o).next((function() {
        return c;
    }));
}
 ...
 * limitations under the License.
 */
/** A mutation queue for a specific user, backed by IndexedDB. */ Zi.DEFAULT_COLLECTION_PERCENTILE = 10, 
Zi.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT = 1e3, Zi.DEFAULT = new Zi(41943040, Zi.DEFAULT_COLLECTION_PERCENTILE, Zi.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT), 
Zi.DISABLED = new Zi(-1, 0, 0);
...
var no = /** @class */ function() {
     ...
     */
    t, e, n, r) {
        this.userId = t, this.O = e, this.indexManager = n, this.referenceDelegate = r, 
        /**
    ...
    return t.Jt = function(e, n, r, i) {
        ...
        return s.add({}).next((function(u) {
            Q("number" == typeof u);
            for (var a = new di(u, e, n, r), c = function(t, e, n) {
                var r = n.baseMutations.map((function(e) {
                    return fr(t.Ht, e);
                })), i = n.mutations.map((function(e) {
                    return fr(t.Ht, e);
                }));
                return new Pr(e, n.batchId, n.localWriteTime.toMillis(), r, i);
            }(i.O, i.userId, a), h = [], l = new kn((function(t, e) {
                return ct(t.canonicalString(), e.canonicalString());
            })), f = 0, d = r; f < d.length; f++) {
                var p = d[f], y = Rr.key(i.userId, p.key.path, u);
                l = l.add(p.key.path.popLast()), h.push(s.put(c)), h.push(o.put(y, Rr.PLACEHOLDER));
            }
            return l.forEach((function(e) {
                h.push(i.indexManager.addToCollectionParentIndex(t, e));
            })), t.addOnCommittedListener((function() {
                i.Ke[u] = a.keys();
            })), ei.waitFor(h).next((function() {
                return a;
            }));
        }));
        ...
        return io(t).get(e).next((function(t) {
            return t ? (Q(t.userId === n.userId), Si(n.O, t)) : null;
        }));
    }, 
    /**
    ...
    t.prototype.Ge = function(t, e) {
        var n = this;
        return this.Ke[e] ? ei.resolve(this.Ke[e]) : this.lookupMutationBatch(t, e).next((function(t) {
            if (t) {
                var r = t.keys();
                return n.Ke[e] = r, r;
            }
        ...
        return io(t).Qt({
            ...
            e.userId === n.userId && (Q(e.batchId >= r), o = Si(n.O, e)), i.done();
        })).next((function() {
            return o;
        }));
        ...
        return io(t).qt(Pr.userMutationsIndex, n).next((function(t) {
            return t.map((function(t) {
                return Si(e.O, t);
            }));
        }));
    }, t.prototype.getAllMutationBatchesAffectingDocumentKey = function(t, e) {
        var n = this, r = Rr.prefixForPath(this.userId, e.path), i = IDBKeyRange.lowerBound(r), o = [];
        ...
        // the given documentKey.
            ...
            return io(t).get(c).next((function(t) {
                if (!t) throw G();
                Q(t.userId === n.userId), o.push(Si(n.O, t));
            }));
            s.done();
        })).next((function() {
            return o;
        ...
        var n = this, r = new kn(ct), i = [];
        return e.forEach((function(e) {
            var o = Rr.prefixForPath(n.userId, e.path), s = IDBKeyRange.lowerBound(o), u = oo(t).Qt({
                range: s
            }, (function(t, i, o) {
            ...
            i.push(u);
        })), ei.waitFor(i).next((function() {
            return n.je(t, r);
        }));
    }, t.prototype.getAllMutationBatchesAffectingQuery = function(t, e) {
        var n = this, r = e.path, i = r.length + 1, o = Rr.prefixForPath(this.userId, r), s = IDBKeyRange.lowerBound(o), u = new kn(ct);
        return oo(t).Qt({
            range: s
        }, (function(t, e, o) {
        ...
        return e.forEach((function(e) {
            i.push(io(t).get(e).next((function(t) {
                if (null === t) throw G();
                Q(t.userId === n.userId), r.push(Si(n.O, t));
            })));
        })), ei.waitFor(i).next((function() {
            return r;
        }));
        ...
        var n = this;
        return to(t.zt, this.userId, e).next((function(r) {
            return t.addOnCommittedListener((function() {
                n.Qe(e.batchId);
            })), ei.forEach(r, (function(e) {
    ...
    t.prototype.Qe = function(t) {
        ...
        return this.checkEmpty(t).next((function(n) {
            if (!n) return ei.resolve();
            // Verify that there are no entries in the documentMutations index if
            // the queue is empty.
                        var r = IDBKeyRange.lowerBound(Rr.prefixForUser(e.userId)), i = [];
            return oo(t).Qt({
                range: r
            }, (function(t, n, r) {
                if (t[0] === e.userId) {
        ...
        return ro(t, this.userId, e);
    }, 
    // PORTING NOTE: Multi-tab only (state is held in memory in other clients).
    /** Returns the mutation queue's metadata from IndexedDb. */
    t.prototype.We = function(t) {
        var e = this;
        return so(t).get(this.userId).next((function(t) {
            return t || new Or(e.userId, -1, 
            /*lastStreamToken=*/ "");
        }));
    }, t;
}();
 ...
 */ function ro(t, e, n) {
    var r = Rr.prefixForPath(e, n.path), i = r[1], o = IDBKeyRange.lowerBound(r), s = !1;
    return oo(t).Qt({
        range: o,
        jt: !0
    }, (function(t, n, r) {
 ...
 */ function io(t) {
    return fi(t, Pr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function oo(t) {
    return fi(t, Rr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function so(t) {
    return fi(t, Or.store);
}
 ...
 */ var uo = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        var e = this;
        return this.Ye(t).next((function(n) {
            var r = new uo(n.highestTargetId);
            return n.highestTargetId = r.next(), e.Xe(t, n).next((function() {
                return n.highestTargetId;
            }));
        }));
    }, t.prototype.getLastRemoteSnapshotVersion = function(t) {
        return this.Ye(t).next((function(t) {
        ...
        var r = this;
        return this.Ye(t).next((function(i) {
            return i.highestListenSequenceNumber = e, n && (i.lastRemoteSnapshotVersion = n.toTimestamp()), 
            e > i.highestListenSequenceNumber && (i.highestListenSequenceNumber = e), r.Xe(t, i);
        }));
    }, t.prototype.addTargetData = function(t, e) {
        var n = this;
        return this.Ze(t, e).next((function() {
            return n.Ye(t).next((function(r) {
                return r.targetCount += 1, n.tn(e, r), n.Xe(t, r);
            }));
        }));
        ...
        return this.removeMatchingKeysForTargetId(t, e.targetId).next((function() {
            return co(t).delete(e.targetId);
        })).next((function() {
            return n.Ye(t);
        })).next((function(e) {
            return Q(e.targetCount > 0), e.targetCount -= 1, n.Xe(t, e);
        }));
    }, 
    /**
     ...
     */
    t.prototype.forEachTarget = function(t, e) {
        return co(t).Qt((function(t, n) {
            var r = Ni(n);
            e(r);
        }));
    }, t.prototype.Ye = function(t) {
        return ho(t).get(Br.key).next((function(t) {
            return Q(null !== t), t;
        }));
    }, t.prototype.Xe = function(t, e) {
        return ho(t).put(Br.key, e);
    }, t.prototype.Ze = function(t, e) {
        return co(t).put(_i(this.O, e));
    }, 
    /**
    ...
    t.prototype.tn = function(t, e) {
        ...
        var n = ue(e), r = IDBKeyRange.bound([ n, Number.NEGATIVE_INFINITY ], [ n, Number.POSITIVE_INFINITY ]), i = null;
        return co(t).Qt({
            range: r,
        ...
        // IndexedDb.
                return ei.forEach(e, (function(e) {
            var o = _r(e.path);
            return ei.waitFor([ i.delete([ n, o ]), r.referenceDelegate.removeReference(t, n, e) ]);
        }));
    }, t.prototype.removeMatchingKeysForTargetId = function(t, e) {
        var n = lo(t), r = IDBKeyRange.bound([ e ], [ e + 1 ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return n.delete(r);
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), r = lo(t), i = Vn();
        return r.Qt({
            range: n,
            jt: !0
        }, (function(t, e, n) {
            var r = Dr(t[1]), o = new Mt(r);
            i = i.add(o);
        })).next((function() {
            return i;
        }));
    }, t.prototype.containsKey = function(t, e) {
        var n = _r(e.path), r = IDBKeyRange.bound([ n ], [ lt(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), i = 0;
        return lo(t).Qt({
 ...
 */ function ho(t) {
    return fi(t, Br.store);
}

/**
 * Helper to get a typed SimpleDbStore for the document target object store.
 */ function lo(t) {
    return fi(t, Ur.store);
}
 ...
 */ function fo(t) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(e) {
            if (t.code !== H.FAILED_PRECONDITION || t.message !== Zr) throw t;
 ...
 */ var yo = /** @class */ function() {
    function t(t) {
        this.en = t, this.buffer = new kn(po), this.nn = 0;
    }
    return t.prototype.sn = function() {
        return ++this.nn;
    }, t.prototype.rn = function(t) {
        var e = [ t, this.sn() ];
        if (this.buffer.size < this.en) this.buffer = this.buffer.add(e); else {
            var n = this.buffer.last();
            po(e, n) < 0 && (this.buffer = this.buffer.delete(n).add(e));
        }
    ...
    return t.prototype.start = function(t) {
        ...
        var e = this, i = this.on ? 3e5 : 6e4;
        U("LruGarbageCollector", "Garbage collection scheduled in " + i + "ms"), this.cn = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , i, (function() {
            return n(e, void 0, void 0, (function() {
                var e;
                return r(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        this.cn = null, this.on = !0, n.label = 1;
                      ...
                      case 3:
                        return si(e = n.sent()) ? (U("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", e), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    return t.prototype.calculateTargetCount = function(t, e) {
        return this.an.hn(t).next((function(t) {
            return Math.floor(e / 100 * t);
        }));
    }, t.prototype.nthSequenceNumber = function(t, e) {
        var n = this;
        if (0 === e) return ei.resolve(st.A);
        var r = new yo(e);
        return this.an.forEachTarget(t, (function(t) {
            return r.rn(t.sequenceNumber);
        })).next((function() {
            return n.an.ln(t, (function(t) {
                return r.rn(t);
            }));
        })).next((function() {
            return r.maxValue;
        ...
        ei.resolve($i)) : this.getCacheSize(t).next((function(r) {
        ...
        return this.calculateTargetCount(t, this.params.percentileToCollect).next((function(e) {
            ...
            return a = Date.now(), F() <= l.DEBUG && U("LruGarbageCollector", "LRU Garbage Collection\n\tCounted targets in " + (o - h) + "ms\n\tDetermined least recently used " + r + " in " + (s - o) + "ms\n\tRemoved " + i + " targets in " + (u - s) + "ms\n\tRemoved " + t + " documents in " + (a - u) + "ms\nTotal Duration: " + (a - h) + "ms"), 
            ei.resolve({
                didRun: !0,
    ...
    t.prototype.wn = function(t, e) {
        return function(t, e) {
            var n = !1;
            return so(t).Wt((function(r) {
                return ro(t, r, e).next((function(t) {
                    return t && (n = !0), ei.resolve(!t);
                }));
            })).next((function() {
                return n;
            }));
        ...
        return this._n(t, (function(s, u) {
            if (u <= e) {
                var a = n.wn(t, s).next((function(e) {
                    if (!e) 
                    // Our size accounting requires us to read all documents before
                    // removing them.
                    return o++, r.getEntry(t, s).next((function() {
                        return r.removeEntry(s, dt.min()), lo(t).delete([ 0, _r(s.path) ]);
                    }));
                }));
                i.push(a);
            }
 ...
 */ var bo = /** @class */ function() {
    ...
    function t() {
        ...
        this.changes = new bo((function(t) {
            return t.toString();
        }), (function(t, e) {
            return t.isEqual(e);
    ...
    t.prototype.getEntry = function(t, e) {
        ...
        return void 0 !== n ? ei.resolve(n) : this.getFromCache(t, e);
    }, 
    /**
    ...
    t.prototype.updateMetadata = function(t, e) {
        ...
        return this.getMetadata(t).next((function(r) {
            return r.byteSize += e, n.mn(t, r);
        }));
    }, t.prototype.getEntry = function(t, e) {
        var n = this;
        return No(t).get(_o(e)).next((function(t) {
            return n.gn(e, t);
        }));
    }, 
    /**
    ...
    t.prototype.yn = function(t, e) {
        ...
        var n = this, r = On();
        return this.pn(t, e, (function(t, e) {
            var i = n.gn(t, e);
            r = r.insert(t, i);
        })).next((function() {
            return r;
    ...
    t.prototype.In = function(t, e) {
        var n = this, r = On(), i = new Nn(Mt.comparator);
        return this.pn(t, e, (function(t, e) {
            var o = n.gn(t, e);
        ...
        if (e.isEmpty()) return ei.resolve();
        ...
        return No(t).Qt({
            ...
            o ? r.Ut(o.path.toArray()) : r.done();
        })).next((function() {
            // The rest of the keys are not in the cache. One case where `iterate`
            // above won't go through them is when the cache is empty.
            for (;o; ) n(o, null), o = i.hasNext() ? i.getNext() : null;
        }));
    }, t.prototype.getAll = function(t, e, n) {
        var r = this, i = On(), o = e.length + 1, s = {};
        if (n.isEqual(dt.min())) {
        ...
        return No(t).Qt(s, (function(t, n, s) {
            ...
            if (t.length === o) {
                var u = r.gn(Mt.fromSegments(t), n);
                e.isPrefixOf(u.key.path) ? i = i.insert(u.key, u) : s.done();
            }
        })).next((function() {
            return i;
        }));
    }, t.prototype.newChangeBuffer = function(t) {
        return new Eo(this, !!t && t.trackRemovals);
    }, t.prototype.getSize = function(t) {
        return this.getMetadata(t).next((function(t) {
            return t.byteSize;
        }));
    }, t.prototype.getMetadata = function(t) {
        return So(t).get(Fr.key).next((function(t) {
            return Q(!!t), t;
        }));
    }, t.prototype.mn = function(t, e) {
        return So(t).put(Fr.key, e);
    }, 
    /**
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).Tn = t, r.trackRemovals = n, 
        // A map of document sizes prior to applying the changes in this buffer.
        r.An = new bo((function(t) {
            return t.toString();
        }), (function(t, e) {
            return t.isEqual(e);
        })), r;
    ...
    return t(n, e), n.prototype.applyChanges = function(t) {
        var e = this, n = [], r = 0, i = new kn((function(t, e) {
            return ct(t.canonicalString(), e.canonicalString());
        }));
        return this.changes.forEach((function(o, s) {
            var u = e.An.get(o);
            if (s.isValidDocument()) {
                var a = wi(e.Tn.O, s);
                i = i.add(o.path.popLast());
                var c = eo(a);
                r += c - u, n.push(e.Tn.addEntry(t, o, a));
            } else if (r -= u, e.trackRemovals) {
                // In order to track removals, we store a "sentinel delete" in the
                // RemoteDocumentCache. This entry is represented by a NoDocument
                // with a version of 0 and ignored by `maybeDecodeDocument()` but
                // preserved in `getNewDocumentChanges()`.
                var h = wi(e.Tn.O, s.convertToNoDocument(dt.min()));
                n.push(e.Tn.addEntry(t, o, h));
            } else n.push(e.Tn.removeEntry(t, o));
        })), i.forEach((function(r) {
            n.push(e.Tn.indexManager.addToCollectionParentIndex(t, r));
        })), n.push(this.Tn.updateMetadata(t, r)), ei.waitFor(n);
    }, n.prototype.getFromCache = function(t, e) {
        var n = this;
        // Record the size of everything we load from the cache so we can compute a delta later.
                return this.Tn.yn(t, e).next((function(t) {
            return n.An.set(e, t.size), t.document;
        }));
    }, n.prototype.getAllFromCache = function(t, e) {
        var n = this;
        // Record the size of everything we load from the cache so we can compute
        // a delta later.
                return this.Tn.In(t, e).next((function(t) {
            var e = t.documents;
            // Note: `getAllFromCache` returns two maps instead of a single map from
            // keys to `DocumentSizeEntry`s. This is to allow returning the
            // `MutableDocumentMap` directly, without a conversion.
            return t.En.forEach((function(t, e) {
                n.An.set(t, e);
            })), e;
        }));
    }, n;
 ...
 */ function So(t) {
    return fi(t, Fr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the remoteDocuments object store.
 */ function No(t) {
    return fi(t, Vr.store);
}
 ...
 * limitations under the License.
 */
/** Performs database creation and schema upgrades. */ var Ao = /** @class */ function() {
    function t(t) {
        this.O = t;
    }
    /**
     ...
     */    return t.prototype.kt = function(t, e, n, r) {
        var i = this, o = new ni("createOrUpgrade", e);
        n < 1 && r >= 1 && (function(t) {
            ...
            t.createObjectStore(Or.store, {
                ...
                keyPath: Pr.keyPath,
                autoIncrement: !0
            }).createIndex(Pr.userMutationsIndex, Pr.userMutationsKeyPath, {
                unique: !0
        ...
        0 !== n && (function(t) {
            t.deleteObjectStore(Ur.store), t.deleteObjectStore(qr.store), t.deleteObjectStore(Br.store);
        }(t), ko(t)), s = s.next((function() {
            /**
     ...
     */
        ...
        s = s.next((function() {
            return function(t, e) {
                return e.store(Pr.store).qt().next((function(n) {
                    t.deleteObjectStore(Pr.store), t.createObjectStore(Pr.store, {
                        keyPath: Pr.keyPath,
                        autoIncrement: !0
                    }).createIndex(Pr.userMutationsIndex, Pr.userMutationsKeyPath, {
                        unique: !0
                    });
                    var r = e.store(Pr.store), i = n.map((function(t) {
                        return r.put(t);
                    }));
                    return ei.waitFor(i);
                }));
            ...
            !function(t) {
                var e = t.createObjectStore(Yr.store, {
                    keyPath: Yr.keyPath
                });
                e.createIndex(Yr.collectionPathOverlayIndex, Yr.collectionPathOverlayIndexPath, {
                    unique: !1
                }), e.createIndex(Yr.collectionGroupOverlayIndex, Yr.collectionGroupOverlayIndexPath, {
                    unique: !1
                });
            }(t);
            ...
            !function(t) {
                t.createObjectStore(zr.store, {
                    keyPath: zr.keyPath,
                    autoIncrement: !0
                }).createIndex(zr.collectionGroupIndex, zr.collectionGroupIndexPath, {
                    unique: !1
                }), t.createObjectStore(Wr.store, {
                    keyPath: Wr.keyPath
                }).createIndex(Wr.sequenceNumberIndex, Wr.sequenceNumberIndexPath, {
                    unique: !1
                }), t.createObjectStore(Hr.store, {
                    keyPath: Hr.keyPath
                }).createIndex(Hr.documentKeyIndex, Hr.documentKeyIndexPath, {
                    unique: !1
                });
            }(t);
        }))), s;
        ...
        var e = 0;
        return t.store(Vr.store).Qt((function(t, n) {
            e += eo(n);
        })).next((function() {
            var n = new Fr(e);
        ...
        var e = this, n = t.store(Or.store), r = t.store(Pr.store);
        return n.qt().next((function(n) {
            return ei.forEach(n, (function(n) {
                var i = IDBKeyRange.bound([ n.userId, -1 ], [ n.userId, n.lastAcknowledgedBatchId ]);
                return r.qt(Pr.userMutationsIndex, i).next((function(r) {
                    return ei.forEach(r, (function(r) {
                        Q(r.userId === n.userId);
                        var i = Si(e.O, r);
    ...
    t.prototype.bn = function(t) {
        var e = t.store(Ur.store), n = t.store(Vr.store);
        return t.store(Br.store).get(Br.key).next((function(t) {
            ...
            return n.Qt((function(n, i) {
                ...
                r.push(e.get(s).next((function(n) {
                    return n ? ei.resolve() : function(n) {
                        return e.put(new Ur(0, _r(n), t.highestListenSequenceNumber));
                    }(o);
                })));
            })).next((function() {
                return ei.waitFor(r);
        ...
        var n = e.store(Kr.store), r = new zi, i = function(t) {
            if (r.add(t)) {
        ...
        // Index existing remote documents.
                return e.store(Vr.store).Qt({
            jt: !0
        }, (function(t, e) {
            var n = new gt(t);
            return i(n.popLast());
        })).next((function() {
            return e.store(Rr.store).Qt({
                jt: !0
            }, (function(t, e) {
                t[0];
                var n = t[1];
...
var Do = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", xo = /** @class */ function() {
    function t(
    /**
     ...
     */
    h, l) {
        if (void 0 === l && (l = 12), this.allowTabSynchronization = e, this.persistenceKey = n, 
        this.clientId = r, this.Sn = o, this.window = s, this.document = u, this.Dn = c, 
        this.Cn = h, this.schemaVersion = l, this.Nn = null, this.xn = !1, this.isPrimary = !1, 
        ...
        this.referenceDelegate = new go(this, i), this.Bn = n + "main", this.O = new mi(a), 
        this.Ln = new ri(this.Bn, this.schemaVersion, new Ao(this.O)), this.Un = new ao(this.referenceDelegate, this.O), 
        this.qn = function(t) {
            return new To(t);
        }(this.O), this.Kn = new xi, this.window && this.window.localStorage ? this.Gn = this.window.localStorage : (this.Gn = null, 
     ...
     */    return t.prototype.start = function() {
        ...
        // do.
                return this.jn().then((function() {
            if (!t.isPrimary && !t.allowTabSynchronization) 
            // Fail `start()` if `synchronizeTabs` is disabled and we cannot
            // obtain the primary lease.
            throw new Y(H.FAILED_PRECONDITION, Do);
            return t.Qn(), t.Wn(), t.zn(), t.runTransaction("getHighestListenSequenceNumber", "readonly", (function(e) {
                return t.Un.getHighestSequenceNumber(e);
            }));
        })).then((function(e) {
            t.Nn = new st(e, t.Dn);
        })).then((function() {
            ...
            return t.Ln && t.Ln.close(), Promise.reject(e);
        }));
    }, 
    /**
    ...
    t.prototype.setNetworkEnabled = function(t) {
        ...
        this.Sn.enqueueAndForget((function() {
            return n(e, void 0, void 0, (function() {
                return r(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return this.started ? [ 4 /*yield*/ , this.jn() ] : [ 3 /*break*/ , 2 ];
    ...
    t.prototype.jn = function() {
        ...
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (function(e) {
            return Oo(e).put(new jr(t.clientId, Date.now(), t.networkEnabled, t.inForeground)).next((function() {
                if (t.isPrimary) return t.Jn(e).next((function(e) {
                    e || (t.isPrimary = !1, t.Sn.enqueueRetryable((function() {
                        return t.Fn(!1);
                    })));
                }));
            })).next((function() {
                ...
                return t.isPrimary && !n ? t.Xn(e).next((function() {
                    return !1;
                })) : !!n && t.Zn(e).next((function() {
                    return !0;
                }));
            }));
        })).catch((function(e) {
            ...
            t.isPrimary !== e && t.Sn.enqueueRetryable((function() {
                return t.Fn(e);
            })), t.isPrimary = e;
        }));
    }, t.prototype.Jn = function(t) {
        var e = this;
        return Co(t).get(Cr.key).next((function(t) {
            return ei.resolve(e.ts(t));
        }));
    ...
    t.prototype.ns = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return !this.isPrimary || this.ss(this.$n, 18e5) ? [ 3 /*break*/ , 2 ] : (this.$n = Date.now(), 
                    [ 4 /*yield*/ , this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (function(t) {
                        var e = fi(t, jr.store);
                        return e.qt().next((function(t) {
                            var n = o.rs(t, 18e5), r = t.filter((function(t) {
                                return -1 === n.indexOf(t);
                            }));
                            // Delete metadata for clients that are no longer considered active.
                                                        return ei.forEach(r, (function(t) {
                  ...
                  case 1:
                    ...
                    if (t = r.sent(), this.Gn) for (e = 0, n = t; e < n.length; e++) i = n[e], this.Gn.removeItem(this.os(i.clientId));
                    r.label = 2;
    ...
    t.prototype.zn = function() {
        var t = this;
        this.Mn = this.Sn.enqueueAfterDelay("client_metadata_refresh" /* ClientMetadataRefresh */ , 4e3, (function() {
            return t.jn().then((function() {
                return t.ns();
            })).then((function() {
                return t.zn();
            }));
    ...
    /** Checks whether `client` is the local client. */ t.prototype.ts = function(t) {
    ...
    t.prototype.Yn = function(t) {
        var e = this;
        return this.Cn ? ei.resolve(!0) : Co(t).get(Cr.key).next((function(n) {
            ...
            if (null !== n && e.ss(n.leaseTimestampMs, 5e3) && !e.cs(n.ownerId)) {
                if (e.ts(n) && e.networkEnabled) return !0;
                if (!e.ts(n)) {
            ...
            return !(!e.networkEnabled || !e.inForeground) || Oo(t).qt().next((function(t) {
                return void 0 === e.rs(t, 5e3).find((function(t) {
            ...
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    return this.xn = !1, this.us(), this.Mn && (this.Mn.cancel(), this.Mn = null), this.hs(), 
                    this.ls(), [ 4 /*yield*/ , this.Ln.runTransaction("shutdown", "readwrite", [ Cr.store, jr.store ], (function(e) {
                        var n = new li(e, st.A);
                        return t.Xn(n).next((function() {
                            return t.es(n);
                        }));
                    })) ];
    ...
    t.prototype.rs = function(t, e) {
        ...
        return t.filter((function(t) {
            return n.ss(t.updateTimeMs, e) && !n.cs(t.clientId);
        }));
    }, 
    /**
    ...
    t.prototype.ds = function() {
        ...
        return this.runTransaction("getActiveClients", "readonly", (function(e) {
            return Oo(e).qt().next((function(e) {
                return t.rs(e, 18e5).map((function(t) {
                    return t.clientId;
                }));
            }));
        }));
        ...
        return no.Jt(t, this.O, e, this.referenceDelegate);
        ...
        return Pi.Jt(this.O, t);
    }, t.prototype.getBundleCache = function() {
        return this.Kn;
    }, t.prototype.runTransaction = function(t, e, n) {
        var r = this;
        U("IndexedDbPersistence", "Starting transaction:", t);
        var i, o, s = "readonly" === e ? "readonly" : "readwrite", u = 13 === (i = this.schemaVersion) ? $r : 12 === i ? Xr : 11 === i ? Jr : void G();
        /** Returns the object stores for the provided schema. */        
        // Do all transactions as readwrite against all object stores, since we
        // are the only reader/writer.
        return this.Ln.runTransaction(t, s, u, (function(i) {
            return o = new li(i, r.Nn ? r.Nn.next() : st.A), "readwrite-primary" === e ? r.Jn(o).next((function(t) {
                return !!t || r.Yn(o);
            })).next((function(e) {
                if (!e) throw B("Failed to obtain primary lease for action '" + t + "'."), r.isPrimary = !1, 
                r.Sn.enqueueRetryable((function() {
                    return r.Fn(!1);
                })), new Y(H.FAILED_PRECONDITION, Zr);
                return n(o);
            })).next((function(t) {
                return r.Zn(o).next((function() {
                    return t;
                }));
            })) : r._s(o).next((function() {
                return n(o);
            }));
        })).then((function(t) {
    ...
    t.prototype._s = function(t) {
        var e = this;
        return Co(t).get(Cr.key).next((function(t) {
            if (null !== t && e.ss(t.leaseTimestampMs, 5e3) && !e.cs(t.ownerId) && !e.ts(t) && !(e.Cn || e.allowTabSynchronization && t.allowTabSynchronization)) throw new Y(H.FAILED_PRECONDITION, Do);
        }));
    }, 
    /**
    ...
    t.prototype.Zn = function(t) {
        var e = new Cr(this.clientId, this.allowTabSynchronization, Date.now());
        return Co(t).put(Cr.key, e);
    }, t.Vt = function() {
        return ri.Vt();
    }, 
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.Xn = function(t) {
        var e = this, n = Co(t);
        return n.get(Cr.key).next((function(t) {
            return e.ts(t) ? (U("IndexedDbPersistence", "Releasing primary lease."), n.delete(Cr.key)) : ei.resolve();
        }));
    }, 
    /** Verifies that `updateTimeMs` is within `maxAgeMs`. */ t.prototype.ss = function(t, e) {
        ...
        var t = this;
        null !== this.document && "function" == typeof this.document.addEventListener && (this.On = function() {
            t.Sn.enqueueAndForget((function() {
                return t.inForeground = "visible" === t.document.visibilityState, t.jn();
            }));
    ...
    t.prototype.Wn = function() {
        var t, e = this;
        "function" == typeof (null === (t = this.window) || void 0 === t ? void 0 : t.addEventListener) && (this.kn = function() {
            // Note: In theory, this should be scheduled on the AsyncQueue since it
            // accesses internal state. We execute this code directly during shutdown
            // to make sure it gets a chance to run.
            e.us(), p() && navigator.appVersion.match(/Version\/1[45]/) && 
            // On Safari 14 and 15, we do not run any cleanup actions as it might
            // trigger a bug that prevents Safari from re-opening IndexedDB during
            // the next page load.
            // See https://bugs.webkit.org/show_bug.cgi?id=226547
            e.Sn.enterRestrictedMode(/* purgeExistingTasks= */ !0), e.Sn.enqueueAndForget((function() {
                return e.shutdown();
            }));
    ...
    t.prototype.cs = function(t) {
        var e;
        try {
            var n = null !== (null === (e = this.Gn) || void 0 === e ? void 0 : e.getItem(this.os(t)));
    ...
    /** Removes the zombied client entry if it exists. */ t.prototype.fs = function() {
        if (this.Gn) try {
 ...
 */
function Co(t) {
    return fi(t, Cr.store);
}

/**
 * Helper to get a typed SimpleDbStore for the client metadata object store.
 */ function Oo(t) {
    return fi(t, jr.store);
}
...
var Ro = function(t, e) {
    ...
    return t.prototype.ys = function(t, e) {
        var n = this;
        return this.gs.getAllMutationBatchesAffectingDocumentKey(t, e).next((function(r) {
            return n.ps(t, e, r);
        }));
    }, 
    /** Internal version of `getDocument` that allows reusing batches. */ t.prototype.ps = function(t, e, n) {
        return this.qn.getEntry(t, e).next((function(t) {
    ...
    t.prototype.Ts = function(t, e) {
        var n = this;
        return this.gs.getAllMutationBatchesAffectingDocumentKeys(t, e).next((function(t) {
            return n.Is(e, t);
        }));
    }, 
    /**
 ...
 */
        return function(t) {
            return Mt.isDocumentKey(t.path) && null === t.collectionGroup && 0 === t.filters.length;
        }(e) ? this.Rs(t, e.path) : Ce(e) ? this.Ps(t, e, n) : this.bs(t, e, n);
    }, t.prototype.Rs = function(t, e) {
        // Just do a simple document lookup.
        return this.ys(t, new Mt(e)).next((function(t) {
            var e = Rn();
            return t.isFoundDocument() && (e = e.insert(t.key, t)), e;
        }));
    }, t.prototype.Ps = function(t, e, n) {
        var r = this, i = e.collectionGroup, o = Rn();
        return this.indexManager.getCollectionParents(t, i).next((function(s) {
            return ei.forEach(s, (function(s) {
                var u = function(t, e) {
                    return new Se(e, 
                    /*collectionGroup=*/ null, t.explicitOrderBy.slice(), t.filters.slice(), t.limit, t.limitType, t.startAt, t.endAt);
                }(e, s.child(i));
                return r.bs(t, u, n).next((function(t) {
                    t.forEach((function(t, e) {
                        o = o.insert(t, e);
                    }));
                }));
        ...
        // Query the remote documents and overlay mutations.
                return this.qn.getAll(t, e.path, n).next((function(n) {
            return r = n, i.gs.getAllMutationBatchesAffectingQuery(t, e);
        })).next((function(t) {
            for (var e = 0, n = t; e < n.length; e++) for (var i = n[e], o = 0, s = i.mutations; o < s.length; o++) {
                var u = s[o], a = u.key, c = r.get(a);
                null == c && (
                // Create invalid document to apply mutations on top of
                c = te.newInvalidDocument(a), r = r.insert(a, c)), cn(u, c, i.localWriteTime), c.isFoundDocument() || (r = r.remove(a));
            }
        })).next((function() {
    ...
    function t(t, e, n, r) {
        this.targetId = t, this.fromCache = e, this.vs = n, this.Vs = r;
    }
    return t.Ss = function(e, n) {
        for (var r = Vn(), i = Vn(), o = 0, s = n.docChanges; o < s.length; o++) {
            var u = s[o];
            switch (u.type) {
              case 0 /* Added */ :
                r = r.add(u.doc.key);
    ...
    function t() {}
    /** Sets the document view to query against. */    return t.prototype.Ds = function(t) {
        this.Cs = t;
    }, 
    /** Returns all local documents matching the specified query. */ t.prototype.As = function(t, e, n, r) {
        var i = this;
        ...
        }(e) || n.isEqual(dt.min()) ? this.Ns(t, e) : this.Cs.Es(t, r).next((function(o) {
            var s = i.xs(e, o);
            return (Ae(e) || ke(e)) && i.ks(e.limitType, s, r, n) ? i.Ns(t, e) : (F() <= l.DEBUG && U("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), Ve(e)), 
            i.Cs.As(t, e, n).next((function(t) {
    ...
    /** Applies the query filter and sorting to the provided documents.  */ t.prototype.xs = function(t, e) {
    ...
    t.prototype.ks = function(t, e, n, r) {
        ...
        return F() <= l.DEBUG && U("QueryEngine", "Using full collection scan to execute query:", Ve(e)), 
        this.Cs.As(t, e, dt.min());
    }, t;
}(), Fo = /** @class */ function() {
    function t(
    /** Manages our in-memory or durable persistence. */
    t, e, n, r) {
        this.persistence = t, this.Os = e, this.O = r, 
        /**
        ...
        /**
             ...
             */
        this.Fs = dt.min(), this.Bs = t.getRemoteDocumentCache(), this.Un = t.getTargetCache(), 
    ...
    return t.prototype.Ls = function(t) {
        ...
        this.Us = new Lo(this.Bs, this.gs, this.indexManager), this.Bs.setIndexManager(this.indexManager), 
        this.Os.Ds(this.Us);
    }, t.prototype.collectGarbage = function(t) {
        var e = this;
        return this.persistence.runTransaction("Collect garbage", "readwrite-primary", (function(n) {
            return t.collect(n, e.Ms);
        }));
    }, t;
}();
            ...
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , (n = W(t)).persistence.runTransaction("Handle user change", "readonly", (function(t) {
                    ...
                    // before and after.
                    var r;
                    return n.gs.getAllMutationBatches(t).next((function(i) {
                        return r = i, n.Ls(e), n.gs.getAllMutationBatches(t);
                    })).next((function(e) {
                        for (var i = [], o = [], s = Vn(), u = 0, a = r
                        ...
                        // of mutation batch IDs that were affected by change.
                                                return n.Us.Es(t, s).next((function(t) {
                            return {
                                qs: t,
                                removedBatchIds: i,
                                addedBatchIds: o
 ...
 */ function Bo(t, e) {
    ...
    return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (function(t) {
        var r = e.batch.keys(), i = n.Bs.newChangeBuffer({
            trackRemovals: !0
        });
        return function(t, e, n, r) {
            var i = n.batch, o = i.keys(), s = ei.resolve();
            return o.forEach((function(t) {
                ...
                return t.gs.removeMutationBatch(e, i);
            }));
        }(n, t, e, i).next((function() {
            return i.apply(t);
        })).next((function() {
            return n.gs.performConsistencyCheck(t);
        })).next((function() {
            return n.Us.Es(t, r);
        }));
    }));
 ...
 */ function Ko(t) {
    ...
    return e.persistence.runTransaction("Get last remote snapshot version", "readonly", (function(t) {
        return e.Un.getLastRemoteSnapshotVersion(t);
    }));
}
 ...
 * queue.
 */ function jo(t, e) {
    var n = W(t), r = e.snapshotVersion, i = n.Ms;
    return n.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(t) {
        var o = n.Bs.newChangeBuffer({
            trackRemovals: !0
        });
        ...
        e.targetChanges.forEach((function(o, u) {
            ...
            if (a) {
                ...
                s.push(n.Un.removeMatchingKeys(t, o.removedDocuments, u).next((function() {
                    return n.Un.addMatchingKeys(t, o.addedDocuments, u);
                })));
     ...
     */
                ...
                }(a, c, o) && s.push(n.Un.updateTargetData(t, c));
            }
        }));
        var u = On();
        ...
        s.push(Go(t, o, e.documentUpdates).next((function(t) {
            u = t;
        }))), !r.isEqual(dt.min())) {
            var a = n.Un.getLastRemoteSnapshotVersion(t).next((function(e) {
                return n.Un.setTargetsMetadata(t, t.currentSequenceNumber, r);
            }));
            s.push(a);
        }
        return ei.waitFor(s).next((function() {
            return o.apply(t);
        })).next((function() {
            return n.Us.Ts(t, u);
        })).next((function() {
...
function Qo(t, e) {
    ...
    return n.persistence.runTransaction("Get next mutation batch", "readonly", (function(t) {
        return void 0 === e && (e = -1), n.gs.getNextMutationBatchAfterBatchId(t, e);
    }));
}
 ...
 */ function zo(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (function(t) {
        var r;
        return n.Un.getTargetData(t, e).next((function(i) {
            return i ? (
            // This target has been listened to previously, so reuse the
            // previous targetID.
            // TODO(mcg): freshen last accessed date?
            r = i, ei.resolve(r)) : n.Un.allocateTargetId(t).next((function(i) {
                return r = new vi(e, i, 0 /* Listen */ , t.currentSequenceNumber), n.Un.addTargetData(t, r).next((function() {
                    return r;
                }));
            }));
        }));
        ...
        // the in-memory data
        var r = n.Ms.get(t.targetId);
        return (null === r || t.snapshotVersion.compareTo(r.snapshotVersion) > 0) && (n.Ms = n.Ms.insert(t.targetId, t), 
...
function Wo(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                n = W(t), o = n.Ms.get(e), s = i ? "readwrite" : "readwrite-primary", r.label = 1;
              ...
              case 5:
                return n.Ms = n.Ms.remove(e), n.$s.delete(o.target), [ 2 /*return*/ ];
            }
        }));
    }));
}
 ...
 */ function Ho(t, e, n) {
    var r = W(t), i = dt.min(), o = Vn();
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            var r = W(t), i = r.$s.get(n);
            return void 0 !== i ? ei.resolve(r.Ms.get(i)) : r.Un.getTargetData(e, n);
        }(r, t, Pe(e)).next((function(e) {
            if (e) return i = e.lastLimboFreeSnapshotVersion, r.Un.getMatchingKeysForTargetId(t, e.targetId).next((function(t) {
                o = t;
            }));
        })).next((function() {
            return r.Os.As(t, e, n ? i : dt.min(), n ? o : Vn());
        })).next((function(t) {
            return {
                documents: t,
                Ks: o
...
// PORTING NOTE: Multi-Tab only.
function Yo(t, e) {
    var n = W(t), r = W(n.Un), i = n.Ms.get(e);
...
function Jo(t) {
    ...
    return e.persistence.runTransaction("Get new document changes", "readonly", (function(t) {
        return function(t, e, n) {
            var r = W(t), i = On(), o = bi(n), s = No(e), u = IDBKeyRange.lowerBound(o, !0);
            return s.Qt({
 ...
 */ function $o(t, e, i, o) {
    return n(this, void 0, void 0, (function() {
        var n, s, u, a, c, h, l, f, d, p;
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                for (n = W(t), s = Vn(), u = On(), a = 0, c = i; a < c.length; a++) h = c[a], l = e.Gs(h.metadata.name), 
                h.document && (s = s.add(l)), (f = e.js(h)).setReadTime(e.Qs(h.metadata.readTime)), 
                u = u.insert(l, f);
                return d = n.Bs.newChangeBuffer({
                    trackRemovals: !0
                }), [ 4 /*yield*/ , zo(n, function(t) {
                    // It is OK that the path used for the query is not valid, because this will
                    // not be read and queried.
                    return Pe(_e(gt.fromString("__bundle__/docs/" + t)));
                }(o)) ];
              ...
              case 1:
                ...
                return p = r.sent(), [ 2 /*return*/ , n.persistence.runTransaction("Apply bundle documents", "readwrite", (function(t) {
                    return Go(t, d, u).next((function(e) {
                        return d.apply(t), e;
                    })).next((function(e) {
                        return n.Un.removeMatchingKeysForTargetId(t, p.targetId).next((function() {
                            return n.Un.addMatchingKeys(t, s, p.targetId);
                        })).next((function() {
                            return n.Us.Ts(t, e);
                        })).next((function() {
                            return e;
 ...
 */ function Zo(t, e, i) {
    return void 0 === i && (i = Vn()), n(this, void 0, void 0, (function() {
        var n, o;
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , zo(t, Pe(Ai(e.bundledQuery))) ];
              ...
              case 1:
                return n = r.sent(), [ 2 /*return*/ , (o = W(t)).persistence.runTransaction("Save named query", "readwrite", (function(t) {
                    ...
                    // has.
                                        if (n.snapshotVersion.compareTo(r) >= 0) return o.Kn.saveNamedQuery(t, e);
                    // Update existing target data because the query from the bundle is newer.
                                        var s = n.withResumeToken(Et.EMPTY_BYTE_STRING, r);
                    return o.Ms = o.Ms.insert(s.targetId, s), o.Un.updateTargetData(t, s).next((function() {
                        return o.Un.removeMatchingKeysForTargetId(t, n.targetId);
                    })).next((function() {
                        return o.Un.addMatchingKeys(t, i, n.targetId);
                    })).next((function() {
                        return o.Kn.saveNamedQuery(t, e);
                    }));
                })) ];
            }
        }));
 ...
 */ var ts = /** @class */ function() {
    ...
    return t.prototype.getBundleMetadata = function(t, e) {
        return ei.resolve(this.Ws.get(e));
    }, t.prototype.saveBundleMetadata = function(t, e) {
    ...
    function t() {
        ...
        this.overlays = new Nn(Mt.comparator), this.Hs = new Map;
    }
    return t.prototype.getOverlay = function(t, e) {
        return ei.resolve(this.overlays.get(e));
    }, t.prototype.saveOverlays = function(t, e, n) {
        var r = this;
        return n.forEach((function(n) {
            r.Yt(t, e, n);
        ...
        var r = this, i = this.Hs.get(n);
        return void 0 !== i && (i.forEach((function(t) {
            return r.overlays = r.overlays.remove(t);
        })), this.Hs.delete(n)), ei.resolve();
    }, t.prototype.getOverlaysForCollection = function(t, e, n) {
        for (var r = new Map, i = e.length + 1, o = new Mt(e.child("")), s = this.overlays.getIteratorFrom(o); s.hasNext(); ) {
        ...
        for (var i = new Nn((function(t, e) {
            ...
            if (s.getKey().getCollectionGroup() === e && s.largestBatchId > n) {
                ...
                null === u && (u = new Map, i = i.insert(s.largestBatchId, u)), u.set(s.getKey(), s);
            }
        }
        for (var a = new Map, c = i.getIterator(); c.hasNext() && (c.getNext().value.forEach((function(t, e) {
            return a.set(e, t);
        })), !(a.size >= r)); ) ;
        return ei.resolve(a);
        ...
        if (null !== n) {
            ...
            null !== r && this.Hs.get(r.largestBatchId).delete(n.key), this.overlays = this.overlays.insert(n.key, new yi(e, n));
    ...
    function t() {
        ...
        this.Js = new kn(rs.Ys), 
        // A set of outstanding references to a document sorted by target id.
        this.Xs = new kn(rs.Zs)
    ...
    t.prototype.si = function(t) {
        var e = this, n = new Mt(new gt([])), r = new rs(n, t), i = new rs(n, t + 1), o = [];
        return this.Xs.forEachInRange([ r, i ], (function(t) {
            e.ei(t), o.push(t.key);
        })), o;
    }, t.prototype.ii = function() {
        var t = this;
        this.Js.forEach((function(e) {
            return t.ei(e);
        }));
    }, t.prototype.ei = function(t) {
        this.Js = this.Js.delete(t), this.Xs = this.Xs.delete(t);
    }, t.prototype.ri = function(t) {
        var e = new Mt(new gt([])), n = new rs(e, t), r = new rs(e, t + 1), i = Vn();
        return this.Xs.forEachInRange([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.containsKey = function(t) {
        var e = new rs(t, 0), n = this.Js.firstAfterOrEqual(e);
    ...
    return t.Ys = function(t, e) {
        return Mt.comparator(t.key, e.key) || ct(t.oi, e.oi);
    }, 
    /** Compare by ID then by key */ t.Zs = function(t, e) {
        return ct(t.oi, e.oi) || Mt.comparator(t.key, e.key);
    }, t;
}(), is = /** @class */ function() {
    function t(t, e) {
        ...
        this.ui = new kn(rs.Ys);
    }
    return t.prototype.checkEmpty = function(t) {
        return ei.resolve(0 === this.gs.length);
    }, t.prototype.addMutationBatch = function(t, e, n, r) {
        var i = this.ci;
        ...
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.ui = this.ui.add(new rs(a.key, i)), this.indexManager.addToCollectionParentIndex(t, a.key.path.popLast());
        }
        return ei.resolve(o);
    }, t.prototype.lookupMutationBatch = function(t, e) {
        return ei.resolve(this.ai(e));
    }, t.prototype.getNextMutationBatchAfterBatchId = function(t, e) {
        var n = e + 1, r = this.hi(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return ei.resolve(this.gs.length > i ? this.gs[i] : null);
    }, t.prototype.getHighestUnacknowledgedBatchId = function() {
        return ei.resolve(0 === this.gs.length ? -1 : this.ci - 1);
    }, t.prototype.getAllMutationBatches = function(t) {
        return ei.resolve(this.gs.slice());
    }, t.prototype.getAllMutationBatchesAffectingDocumentKey = function(t, e) {
        var n = this, r = new rs(e, 0), i = new rs(e, Number.POSITIVE_INFINITY), o = [];
        return this.ui.forEachInRange([ r, i ], (function(t) {
            var e = n.ai(t.oi);
            o.push(e);
        })), ei.resolve(o);
    }, t.prototype.getAllMutationBatchesAffectingDocumentKeys = function(t, e) {
        var n = this, r = new kn(ct);
        return e.forEach((function(t) {
            var e = new rs(t, 0), i = new rs(t, Number.POSITIVE_INFINITY);
            n.ui.forEachInRange([ e, i ], (function(t) {
                r = r.add(t.oi);
            }));
        })), ei.resolve(this.li(r));
    }, t.prototype.getAllMutationBatchesAffectingQuery = function(t, e) {
        ...
        var o = new rs(new Mt(i), 0), s = new kn(ct);
        // Find unique batchIDs referenced by all documents potentially matching the
        // query.
                return this.ui.forEachWhile((function(t) {
            var e = t.key.path;
            ...
            // TODO(mcg): we'll need a different scanner when we implement
            // ancestor queries.
            e.length === r && (s = s.add(t.oi)), !0);
        }), o), ei.resolve(this.li(s));
        ...
        var n = this;
        Q(0 === this.fi(e.batchId, "removed")), this.gs.shift();
        var r = this.ui;
        return ei.forEach(e.mutations, (function(i) {
            var o = new rs(i.key, e.batchId);
        ...
        var n = new rs(e, 0), r = this.ui.firstAfterOrEqual(n);
        return ei.resolve(e.isEqual(r && r.key));
    }, t.prototype.performConsistencyCheck = function(t) {
        return this.gs.length, ei.resolve();
    }, 
    /**
    ...
    t.prototype.hi = function(t) {
        return 0 === this.gs.length ? 0 : t - this.gs[0].batchId;
    ...
    t.prototype.ai = function(t) {
        var e = this.hi(t);
        return e < 0 || e >= this.gs.length ? null : this.gs[e];
    }, t;
}(), os = /** @class */ function() {
    /**
    ...
    function t(t) {
        ...
        this.docs = new Nn(Mt.comparator), 
    ...
    t.prototype.addEntry = function(t, e) {
        var n = e.key, r = this.docs.get(n), i = r ? r.size : 0, o = this.di(e);
    ...
    t.prototype.removeEntry = function(t) {
        ...
        return ei.resolve(n ? n.document.mutableCopy() : te.newInvalidDocument(e));
    }, t.prototype.getEntries = function(t, e) {
        var n = this, r = On();
        return e.forEach((function(t) {
            var e = n.docs.get(t);
            r = r.insert(t, e ? e.document.mutableCopy() : te.newInvalidDocument(t));
        })), ei.resolve(r);
    }, t.prototype.getAll = function(t, e, n) {
        for (var r = On(), i = new Mt(e.child("")), o = this.docs.getIteratorFrom(i)
        // Documents are ordered by key, so we can use a prefix scan to narrow down
        // the documents we need to match the query against.
        ; o.hasNext(); ) {
            var s = o.getNext(), u = s.key, a = s.value.document;
            if (!e.isPrefixOf(u.path)) break;
            u.path.length > e.length + 1 || a.readTime.compareTo(n) <= 0 || (r = r.insert(a.key, a.mutableCopy()));
        }
        return ei.resolve(r);
    }, t.prototype._i = function(t, e) {
        return ei.forEach(this.docs, (function(t) {
            return e(t);
        }));
    }, t.prototype.newChangeBuffer = function(t) {
    ...
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).Tn = t, n;
    }
    return t(n, e), n.prototype.applyChanges = function(t) {
        var e = this, n = [];
        return this.changes.forEach((function(r, i) {
            i.isValidDocument() ? n.push(e.Tn.addEntry(t, i)) : e.Tn.removeEntry(r);
        })), ei.waitFor(n);
    }, n.prototype.getFromCache = function(t, e) {
...
}(Io), us = /** @class */ function() {
    function t(t) {
        this.persistence = t, 
        /**
             * Maps a target to the data about that target
             */
        this.wi = new bo((function(t) {
            return ue(t);
        }), ae), 
        ...
        /**
             ...
             * IDs.
             */
        this.gi = new ns, this.targetCount = 0, this.yi = uo.He();
    }
    return t.prototype.forEachTarget = function(t, e) {
        return this.wi.forEach((function(t, n) {
            return e(n);
        })), ei.resolve();
    }, t.prototype.getLastRemoteSnapshotVersion = function(t) {
        return ei.resolve(this.lastRemoteSnapshotVersion);
    }, t.prototype.getHighestSequenceNumber = function(t) {
        return ei.resolve(this.mi);
    }, t.prototype.allocateTargetId = function(t) {
        return this.highestTargetId = this.yi.next(), ei.resolve(this.highestTargetId);
    }, t.prototype.setTargetsMetadata = function(t, e, n) {
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.yi = new uo(e), this.highestTargetId = e), t.sequenceNumber > this.mi && (this.mi = t.sequenceNumber);
    }, t.prototype.addTargetData = function(t, e) {
        return this.Ze(e), this.targetCount += 1, ei.resolve();
    }, t.prototype.updateTargetData = function(t, e) {
        return this.Ze(e), ei.resolve();
    }, t.prototype.removeTargetData = function(t, e) {
        return this.wi.delete(e.target), this.gi.si(e.targetId), this.targetCount -= 1, 
        ei.resolve();
    }, t.prototype.removeTargets = function(t, e, n) {
        var r = this, i = 0, o = [];
        return this.wi.forEach((function(s, u) {
            u.sequenceNumber <= e && null === n.get(u.targetId) && (r.wi.delete(s), o.push(r.removeMatchingKeysForTargetId(t, u.targetId)), 
            i++);
        })), ei.waitFor(o).next((function() {
            return i;
        }));
    }, t.prototype.getTargetCount = function(t) {
        return ei.resolve(this.targetCount);
    }, t.prototype.getTargetData = function(t, e) {
        var n = this.wi.get(e) || null;
        return ei.resolve(n);
    }, t.prototype.addMatchingKeys = function(t, e, n) {
        return this.gi.ti(e, n), ei.resolve();
    }, t.prototype.removeMatchingKeys = function(t, e, n) {
        this.gi.ni(e, n);
        ...
        return this.gi.si(e), ei.resolve();
    }, t.prototype.getMatchingKeysForTargetId = function(t, e) {
        var n = this.gi.ri(e);
        return ei.resolve(n);
    }, t.prototype.containsKey = function(t, e) {
        return ei.resolve(this.gi.containsKey(e));
    }, t;
}(), as = /** @class */ function() {
    /**
    ...
    function t(t, e) {
        var n = this;
        this.pi = {}, this.overlays = {}, this.Nn = new st(0), this.xn = !1, this.xn = !0, 
        this.referenceDelegate = t(this), this.Un = new us(this), this.indexManager = new Qi, 
        this.qn = new os((function(t) {
            return n.referenceDelegate.Ii(t);
        })), this.O = new mi(e), this.Kn = new ts(this.O);
    }
    return t.prototype.start = function() {
        return Promise.resolve();
    }, t.prototype.shutdown = function() {
        ...
        return e || (e = new es, this.overlays[t.toKey()] = e), e;
    }, t.prototype.getMutationQueue = function(t, e) {
        var n = this.pi[t.toKey()];
        return n || (n = new is(e, this.referenceDelegate), this.pi[t.toKey()] = n), n;
    }, t.prototype.getTargetCache = function() {
        return this.Un;
    }, t.prototype.getRemoteDocumentCache = function() {
        return this.qn;
        ...
        var i = new cs(this.Nn.next());
        return this.referenceDelegate.Ei(), n(i).next((function(t) {
            return r.referenceDelegate.Ti(i).next((function() {
                return t;
            }));
        ...
        return ei.or(Object.values(this.pi).map((function(n) {
            return function() {
    ...
    return t.bi = function(e) {
        return new t(e);
    }, Object.defineProperty(t.prototype, "vi", {
        get: function() {
        ...
        return this.Ri.addReference(n, e), this.vi.delete(n.toString()), ei.resolve();
    }, t.prototype.removeReference = function(t, e, n) {
        return this.Ri.removeReference(n, e), this.vi.add(n.toString()), ei.resolve();
    }, t.prototype.markPotentiallyOrphaned = function(t, e) {
        return this.vi.add(e.toString()), ei.resolve();
    }, t.prototype.removeTarget = function(t, e) {
        var n = this;
        this.Ri.si(e.targetId).forEach((function(t) {
            return n.vi.add(t.toString());
        }));
        ...
        // Remove newly orphaned documents.
                return ei.forEach(this.vi, (function(r) {
            var i = Mt.fromPath(r);
            return e.Vi(t, i).next((function(t) {
                t || n.removeEntry(i, dt.min());
            }));
        })).next((function() {
            return e.Pi = null, n.apply(t);
        }));
    }, t.prototype.updateLimboDocument = function(t, e) {
        var n = this;
        return this.Vi(t, e).next((function(t) {
            t ? n.vi.delete(e.toString()) : n.vi.add(e.toString());
        }));
        ...
        var n = this;
        return ei.or([ function() {
            return ei.resolve(n.Ri.containsKey(e));
        }, function() {
            return n.persistence.getTargetCache().containsKey(t, e);
        }, function() {
            return n.persistence.Ai(t, e);
        } ]);
    }, t;
}();
...
// contain.
/** Assembles the key for a mutation batch in WebStorage */ function fs(t, e, n) {
...
/** Assembles the key for a query state in WebStorage */ function ds(t, e) {
...
var ps = /** @class */ function() {
    ...
    return t.Si = function(e, n) {
        for (var r = JSON.parse(n), i = "object" == typeof r && r.activeTargetIds instanceof Array, o = qn(), s = 0; i && s < r.activeTargetIds.length; ++s) i = Lt(r.activeTargetIds[s]), 
    ...
    function t(t, e, n, r, i) {
        this.window = t, this.Sn = e, this.persistenceKey = n, this.xi = r, this.syncEngine = null, 
        this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.ki = this.Oi.bind(this), 
        this.Mi = new Nn(ct), this.started = !1, 
        /**
        ...
        var o = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.Fi = ls(this.persistenceKey, this.xi), 
        this.Bi = 
        /** Assembles the key for the current sequence number. */
        function(t) {
            return "firestore_sequence_number_" + t;
        }(this.persistenceKey), this.Mi = this.Mi.insert(this.xi, new gs), this.Li = new RegExp("^firestore_clients_" + o + "_([^_]*)$"), 
        this.Ui = new RegExp("^firestore_mutations_" + o + "_(\\d+)(?:_(.*))?$"), this.qi = new RegExp("^firestore_targets_" + o + "_(\\d+)$"), 
        this.Ki = 
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.Vt = function(t) {
        ...
        return n(this, void 0, void 0, (function() {
            var t, e, n, i, o, s, u, a, c, h, l, f = this;
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return [ 4 /*yield*/ , this.syncEngine.ds() ];

                  case 1:
                    for (t = r.sent(), e = 0, n = t; e < n.length; e++) (i = n[e]) !== this.xi && (o = this.getItem(ls(this.persistenceKey, i))) && (s = vs.Si(i, o)) && (this.Mi = this.Mi.insert(s.clientId, s));
                    for (this.ji(), (u = this.storage.getItem(this.Ki)) && (a = this.Qi(u)) && this.Wi(a), 
                    c = 0, h = this.$i; c < h.length; c++) l = h[c], this.Oi(l);
                    return this.$i = [], 
        ...
        // by another tab
            ...
            var n = this.storage.getItem(ds(this.persistenceKey, t));
            if (n) {
                var r = ys.Si(t, n);
                r && (e = r.state);
            }
        ...
        this.removeItem(ds(this.persistenceKey, t));
        ...
        // `Window.addEventListener`.
            ...
            if (U("SharedClientState", "EVENT", i.key, i.newValue), i.key === this.Fi) return void B("Received WebStorage notification for local change. Another client might have garbage-collected our state");
            this.Sn.enqueueRetryable((function() {
                return n(e, void 0, void 0, (function() {
                    var t, e, n, o, s, u;
                    return r(this, (function(r) {
                        if (this.started) {
                            if (null !== i.key) if (this.Li.test(i.key)) {
                                if (null == i.newValue) return t = this.er(i.key), [ 2 /*return*/ , this.nr(t, null) ];
                                if (e = this.sr(i.key, i.newValue)) return [ 2 /*return*/ , this.nr(e.clientId, e) ];
                            } else if (this.Ui.test(i.key)) {
                                if (null !== i.newValue && (n = this.ir(i.key, i.newValue))) return [ 2 /*return*/ , this.rr(n) ];
                            } else if (this.qi.test(i.key)) {
                                if (null !== i.newValue && (o = this.cr(i.key, i.newValue))) return [ 2 /*return*/ , this.ur(o) ];
                            } else if (i.key === this.Ki) {
                                if (null !== i.newValue && (s = this.Qi(i.newValue))) return [ 2 /*return*/ , this.Wi(s) ];
                            } else if (i.key === this.Bi) u = function(t) {
                                var e = st.A;
                                if (null != t) try {
                                    var n = JSON.parse(t);
                                ...
                                return e;
                            }(i.newValue), u !== st.A && this.sequenceNumberHandler(u); else if (i.key === this.Gi) return [ 2 /*return*/ , this.syncEngine.ar() ];
                        } else this.$i.push(i);
                        return [ 2 /*return*/ ];
                    }));
                }));
    ...
    }, Object.defineProperty(t.prototype, "Yi", {
        get: function() {
        ...
        var r = new ps(this.currentUser, t, e, n), i = fs(this.persistenceKey, this.currentUser, t);
        this.setItem(i, r.Di());
    }, t.prototype.Ji = function(t) {
        var e = fs(this.persistenceKey, this.currentUser, t);
        this.removeItem(e);
        ...
        var r = ds(this.persistenceKey, t), i = new ys(t, e, n);
        this.setItem(r, i.Di());
    ...
    t.prototype.ir = function(t, e) {
        var n = this.Ui.exec(t), r = Number(n[1]), i = void 0 !== n[2] ? n[2] : null;
        return ps.Si(new L(i), r, e);
    }, 
    /**
    ...
    t.prototype.cr = function(t, e) {
        var n = this.qi.exec(t), r = Number(n[1]);
        return ys.Si(r, e);
    }, 
    /**
    ...
    t.prototype.Qi = function(t) {
        ...
        return n(this, void 0, void 0, (function() {
            return r(this, (function(e) {
                return t.user.uid === this.currentUser.uid ? [ 2 /*return*/ , this.syncEngine.hr(t.batchId, t.state, t.error) ] : (U("SharedClientState", "Ignoring mutation for non-active user " + t.user.uid), 
                [ 2 /*return*/ ]);
            }));
        }));
        ...
        var n = this, r = e ? this.Mi.insert(t, e) : this.Mi.remove(t), i = this.zi(this.Mi), o = this.zi(r), s = [], u = [];
        return o.forEach((function(t) {
            i.has(t) || s.push(t);
        })), i.forEach((function(t) {
            o.has(t) || u.push(t);
        })), this.syncEngine.dr(s, u).then((function() {
            n.Mi = r;
        }));
    ...
    function t() {
        this._r = new gs, this.wr = {}, this.onlineStateHandler = null, this.sequenceNumberHandler = null;
    }
    return t.prototype.addPendingMutation = function(t) {
        ...
        return this._r = new gs, Promise.resolve();
    }, t.prototype.handleUserChange = function(t, e, n) {
        // No op.
    }, t.prototype.setOnlineState = function(t) {
        // No op.
    ...
    return t.prototype.mr = function(t) {
        ...
        for (var t = 0, e = this.Er; t < e.length; t++) {
            (0, e[t])(0 /* AVAILABLE */);
        }
     ...
     * HTTP).
     */
    return t(n, e), n.prototype.Br = function(t, e, n, r) {
    ...
    }, n.prototype.Ur = function(t, e, n) {
        var r = [ this.kr, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], i = k(), o = D(), s = {
        ...
        this.useFetchStreams && (s.xmlHttpFactory = new x({})), this.Fr(s.initMessageHeaders, e, n), 
        ...
        var a = i.createWebChannel(u, s), c = !1, h = !1, l = new Ss({
            Ar: function(t) {
        ...
        return f(a, C.EventType.OPEN, (function() {
            ...
            h || (h = !0, U("Connection", "WebChannel transport closed"), l.Cr());
        })), f(a, C.EventType.ERROR, (function(t) {
            h || (h = !0, K("Connection", "WebChannel transport errored:", t), l.Cr(new Y(H.UNAVAILABLE, "The operation could not be completed")));
 ...
 */
                    ...
                    h = !0, l.Cr(new Y(s, u)), a.close();
                } else U("Connection", "WebChannel received:", n), l.Nr(n);
            }
        })), f(o, O.STAT_EVENT, (function(t) {
            t.stat === P.PROXY ? U("Connection", "Detected buffering proxy") : t.stat === P.NOPROXY && U("Connection", "Detected no buffering proxy");
        })), setTimeout((function() {
    ...
    return t.prototype.Mr = function(t, e, n, r, i) {
        var o = this.$r(t, e);
        U("RestConnection", "Sending: ", o, n);
        var s = {};
        return this.Fr(s, r, i), this.Br(t, o, s, n).then((function(t) {
            return U("RestConnection", "Received: ", t), t;
        }), (function(e) {
            throw K("RestConnection", t + " failed with error: ", e, "url: ", o, "request:", n), 
            e;
        }));
    }, t.prototype.Lr = function(t, e, n, r, i) {
        // The REST API automatically aggregates all of the streamed results, so we
        // can just use the normal invoke() method.
        return this.Mr(t, e, n, r, i);
    }, 
    /**
 ...
 * limitations under the License.
 */ function ks(t) {
    return new Xn(t, /* useProto3Json= */ !0);
}
 ...
 */ var Ds = /** @class */ function() {
     ...
     */ , i) {
        ...
        this.Sn = t, this.timerId = e, this.qr = n, this.Kr = r, this.Gr = i, this.jr = 0, 
        this.Qr = null, 
    ...
    t.prototype.Hr = function(t) {
        ...
        // honored as such).
        var n = Math.floor(this.jr + this.Jr()), r = Math.max(0, Date.now() - this.Wr), i = Math.max(0, n - r);
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && U("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this.jr + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
        this.Qr = this.Sn.enqueueAfterDelay(this.timerId, i, (function() {
            return e.Wr = Date.now(), t();
        })), 
    ...
    /** Returns a random value in the range [-currentBaseMs/2, currentBaseMs/2] */ t.prototype.Jr = function() {
        return (Math.random() - .5) * this.jr;
    }, t;
}(), xs = /** @class */ function() {
    function t(t, e, n, r, i, o, s, u) {
        this.Sn = t, this.Xr = n, this.Zr = r, this.eo = i, this.authCredentialsProvider = o, 
        ...
        /**
             ...
             * close.
             */
        this.no = 0, this.so = null, this.io = null, this.stream = null, this.ro = new Ds(t, e)
        /**
    ...
    t.prototype.stop = function() {
        return n(this, void 0, void 0, (function() {
            return r(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return this.oo() ? [ 4 /*yield*/ , this.close(0 /* Initial */) ] : [ 3 /*break*/ , 2 ];
    ...
    t.prototype.ho = function() {
        ...
        // running a timer (in which case the previous idle timeout still applies).
                this.co() && null === this.so && (this.so = this.Sn.enqueueAfterDelay(this.Xr, 6e4, (function() {
            return t.lo();
        })));
    }, 
    ...
    /** Cancels the health check delayed operation. */ t.prototype.wo = function() {
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    return this._o(), this.wo(), this.ro.cancel(), 
                    // Invalidates any stream-related callbacks (e.g. from auth or the
                    // underlying stream), guaranteeing they won't execute.
                    this.no++, 4 /* Error */ !== t ? 
                    // If this is an intentional close ensure we don't delay our next connection attempt.
                    this.ro.reset() : e && e.code === H.RESOURCE_EXHAUSTED ? (
                    // Log the error. (Probably either 'quota exceeded' or 'max queue length reached'.)
                    B(e.toString()), B("Using maximum backoff delay to prevent overloading the backend."), 
                    this.ro.zr()) : e && e.code === H.UNAUTHENTICATED && 3 /* Healthy */ !== this.state && (
                    ...
                    this.state = t, [ 4 /*yield*/ , this.listener.vr(e) ];
    ...
    t.prototype.mo = function() {}, t.prototype.auth = function() {
        ...
        var e = this.yo(this.no), n = this.no;
        ...
        var n = this, r = this.yo(this.no);
        this.stream = this.Eo(t, e), this.stream.Pr((function() {
            r((function() {
                return n.state = 2 /* Open */ , n.io = n.Sn.enqueueAfterDelay(n.Zr, 1e4, (function() {
                    return n.co() && (n.state = 3 /* Healthy */), Promise.resolve();
                })), n.listener.Pr();
            }));
        })), this.stream.vr((function(t) {
            r((function() {
                return n.Io(t);
            }));
        ...
        var t = this;
        this.state = 5 /* Backoff */ , this.ro.Hr((function() {
    ...
    t.prototype.yo = function(t) {
        var e = this;
        return function(n) {
            e.Sn.enqueueAndForget((function() {
                return e.no === t ? n() : (U("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
    ...
    function n(t, n, r, i, o, s) {
        var u = this;
        return (u = e.call(this, t, "listen_stream_connection_backoff" /* ListenStreamConnectionBackoff */ , "listen_stream_idle" /* ListenStreamIdle */ , "health_check_timeout" /* HealthCheckTimeout */ , n, r, i, s) || this).O = o, 
        u;
    }
    return t(n, e), n.prototype.Eo = function(t, e) {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    return t.N ? (Q(void 0 === e || "string" == typeof e), Et.fromBase64String(e || "")) : (Q(void 0 === e || e instanceof Uint8Array), 
                    Et.fromUint8Array(e || new Uint8Array));
                }(t, e.targetChange.resumeToken), s = e.targetChange.cause, u = s && function(t) {
                    var e = void 0 === t.code ? H.UNKNOWN : Sn(t.code);
                    return new Y(e, t.message || "");
                }(s);
                n = new Gn(r, i, o, u || null);
            } else if ("documentChange" in e) {
                e.documentChange;
                var a = e.documentChange;
                a.document, a.document.name, a.document.updateTime;
                var c = or(t, a.document.name), h = er(a.document.updateTime), l = new $t({
                    mapValue: {
                        fields: a.document.fields
                    }
                }), f = te.newFoundDocument(c, h, l), d = a.targetIds || [], p = a.removedTargetIds || [];
                n = new Kn(d, p, f.key, f);
            } else if ("documentDelete" in e) {
                e.documentDelete;
                var y = e.documentDelete;
                y.document;
                var v = or(t, y.document), m = y.readTime ? er(y.readTime) : dt.min(), g = te.newNoDocument(v, m), w = y.removedTargetIds || [];
                n = new Kn([], w, g.key, g);
            } else if ("documentRemove" in e) {
                e.documentRemove;
                var b = e.documentRemove;
                b.document;
                var I = or(t, b.document), T = b.removedTargetIds || [];
                n = new Kn([], T, I, null);
            } else {
                ...
                var E = e.filter;
                E.targetId;
                var S = E.count || 0, N = new Tn(S), _ = E.targetId;
                n = new jn(_, N);
            }
            return n;
        }(this.O, t), n = function(t) {
            // We have only reached a consistent snapshot for the entire stream if there
            // is a read_time set and it applies to all targets (i.e. the list of
            // targets is empty). The backend is guaranteed to send such responses.
            if (!("targetChange" in t)) return dt.min();
            var e = t.targetChange;
            return e.targetIds && e.targetIds.length ? dt.min() : e.readTime ? er(e.readTime) : dt.min();
        }(t);
    ...
    n.prototype.Ao = function(t) {
        var e = {};
        e.database = ar(this.O), e.addTarget = function(t, e) {
            var n, r = e.target;
            return (n = ce(r) ? {
                documents: pr(t, r)
            } : {
                query: yr(t, r)
            }).targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = Zn(t, e.resumeToken) : e.snapshotVersion.compareTo(dt.min()) > 0 && (
            // TODO(wuandy): Consider removing above check because it is most likely true.
            // Right now, many tests depend on this behaviour though (leaving min() out
            // of serialization).
            n.readTime = $n(t, e.snapshotVersion.toTimestamp())), n;
        }(this.O, t);
        var n = function(t, e) {
            var n = function(t, e) {
                switch (e) {
    ...
    n.prototype.Ro = function(t) {
        var e = {};
        e.database = ar(this.O), e.removeTarget = t, this.fo(e);
    }, n;
}(xs), Os = /** @class */ function(e) {
    function n(t, n, r, i, o, s) {
        var u = this;
        return (u = e.call(this, t, "write_stream_connection_backoff" /* WriteStreamConnectionBackoff */ , "write_stream_idle" /* WriteStreamIdle */ , "health_check_timeout" /* HealthCheckTimeout */ , n, r, i, s) || this).O = o, 
        u.Po = !1, u;
    }
    return t(n, e), Object.defineProperty(n.prototype, "bo", {
        /**
    ...
    n.prototype.start = function() {
        ...
        this.Po && this.vo([]);
    }, n.prototype.Eo = function(t, e) {
        return this.eo.Ur("Write", t, e);
    }, n.prototype.onMessage = function(t) {
        if (
        // Always capture the last stream token.
        Q(!!t.streamToken), this.lastStreamToken = t.streamToken, this.Po) {
            ...
            var e = function(t, e) {
                return t && t.length > 0 ? (Q(void 0 !== e), t.map((function(t) {
                    return function(t, e) {
                        ...
                        var n = t.updateTime ? er(t.updateTime) : er(e);
                        ...
                        n = er(e)), new rn(n, t.transformResults || []);
                    }(t, e);
                }))) : [];
            }(t.writeResults, t.commitTime), n = er(t.commitTime);
            return this.listener.Vo(n, e);
        }
        // The first response is always the handshake response
                return Q(!t.writeResults || 0 === t.writeResults.length), this.Po = !0, 
        this.listener.So();
    }, 
    /**
    ...
    n.prototype.Do = function() {
        ...
        var t = {};
        t.database = ar(this.O), this.fo(t);
    }, 
...
}(xs), Ps = /** @class */ function(e) {
    function n(t, n, r, i) {
        var o = this;
        return (o = e.call(this) || this).authCredentials = t, o.appCheckCredentials = n, 
        o.eo = r, o.O = i, o.Co = !1, o;
    }
    return t(n, e), n.prototype.No = function() {
        if (this.Co) throw new Y(H.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    /** Invokes the provided RPC with auth and AppCheck tokens. */ n.prototype.Mr = function(t, e, n) {
        var r = this;
        return this.No(), Promise.all([ this.authCredentials.getToken(), this.appCheckCredentials.getToken() ]).then((function(i) {
            var o = i[0], s = i[1];
            return r.eo.Mr(t, e, n, o, s);
        })).catch((function(t) {
    ...
    /** Invokes the provided RPC with streamed results with auth and AppCheck tokens. */ n.prototype.Lr = function(t, e, n) {
        var r = this;
        return this.No(), Promise.all([ this.authCredentials.getToken(), this.appCheckCredentials.getToken() ]).then((function(i) {
            var o = i[0], s = i[1];
            return r.eo.Lr(t, e, n, o, s);
        })).catch((function(t) {
            throw "FirebaseError" === t.name ? (t.code === H.UNAUTHENTICATED && (r.authCredentials.invalidateToken(), 
            r.appCheckCredentials.invalidateToken()), t) : new Y(H.UNKNOWN, t.toString());
        }));
    ...
    return t.prototype.Mo = function() {
        var t = this;
        0 === this.xo && (this.$o("Unknown" /* Unknown */), this.ko = this.asyncQueue.enqueueAfterDelay("online_state_timeout" /* OnlineStateTimeout */ , 1e4, (function() {
            return t.ko = null, t.Fo("Backend didn't respond within 10 seconds."), t.$o("Offline" /* Offline */), 
            Promise.resolve();
        })));
    }, 
    /**
    ...
    t.prototype.set = function(t) {
        ...
        this.Oo ? (B(e), this.Oo = !1) : U("OnlineStateTracker", e);
...
e, i, o, s) {
    ...
    /**
             ...
             */
    this.Go = [], this.jo = s, this.jo.mr((function(t) {
        i.enqueueAndForget((function() {
            return n(u, void 0, void 0, (function() {
                return r(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return Gs(this) ? (U("RemoteStore", "Restarting streams for network reachability change."), 
                        [ 4 /*yield*/ , function(t) {
                            return n(this, void 0, void 0, (function() {
                                var e;
                                return r(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = W(t)).Ko.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , Vs(e) ];

                                      case 1:
                                        return n.sent(), e.Qo.set("Unknown" /* Unknown */), e.Ko.delete(4 /* ConnectivityChange */), 
                                        [ 4 /*yield*/ , Ms(e) ];
 ...
 */ function Ms(t) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                if (!Gs(t)) return [ 3 /*break*/ , 4 ];
                e = 0, n = t.Go, r.label = 1;
 ...
 */ function qs(t, e) {
    var n = W(t), r = su(n);
    n.qo.delete(e), r.co() && Bs(n, e), 0 === n.qo.size && (r.co() ? r.ho() : Gs(n) && 
...
function js(t) {
    return Gs(t) && !su(t).oo() && t.qo.size > 0;
}

function Gs(t) {
    return 0 === W(t).Ko.size;
}
...
function zs(t) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(e) {
            return t.qo.forEach((function(e, n) {
                Us(t, e);
            })), [ 2 /*return*/ ];
        }));
    }));
...
function Ws(t, e) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(n) {
            ...
            t.Qo.set("Unknown" /* Unknown */), [ 2 /*return*/ ];
        }));
    }));
}
...
function Hs(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(a) {
            switch (a.label) {
              case 0:
                if (t.Qo.set("Online" /* Online */), !(e instanceof Gn && 2 /* Removed */ === e.state && e.cause)) 
                    ...
                    return n(this, void 0, void 0, (function() {
                        ...
                        return r(this, (function(r) {
                            switch (r.label) {
                              ...
                              case 1:
                                return i < o.length ? (s = o[i], t.qo.has(s) ? [ 4 /*yield*/ , t.remoteSyncer.rejectListen(s, n) ] : [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 5 ];

                              case 2:
                                r.sent(), t.qo.delete(s), t.Wo.removeTarget(s), r.label = 3;
              ...
              case 6:
                if (e instanceof Kn ? t.Wo.ct(e) : e instanceof jn ? t.Wo._t(e) : t.Wo.ht(e), i.isEqual(dt.min())) return [ 3 /*break*/ , 13 ];
                a.label = 7;

              case 7:
                return a.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , Ko(t.localStore) ];
                ...
                function(t, e) {
                    ...
                    // persistent view of these when applying the completed RemoteEvent.
                        ...
                        if (n.resumeToken.approximateByteSize() > 0) {
                            ...
                            // A watched target might have been removed already.
                                                        i && t.qo.set(r, i.withResumeToken(n.resumeToken, e));
                        }
                    })), 
                    ...
                    n.targetMismatches.forEach((function(e) {
                        ...
                        if (n) {
                            ...
                            // state.
                            t.qo.set(e, n.withResumeToken(Et.EMPTY_BYTE_STRING, n.snapshotVersion)), 
                            ...
                            var r = new vi(n.target, e, 1 /* ExistenceFilterMismatch */ , n.sequenceNumber);
                            Us(t, r);
                        }
              ...
              case 11:
                return U("RemoteStore", "Failed to raise snapshot:", u = a.sent()), [ 4 /*yield*/ , Ys(t, u) ];
        ...
        return r(this, (function(s) {
            switch (s.label) {
              case 0:
                ...
                return t.Ko.add(1 /* IndexedDbFailed */), [ 4 /*yield*/ , Vs(t) ];

              case 1:
                // Disable network and raise offline snapshots
                return s.sent(), t.Qo.set("Offline" /* Offline */), i || (
                // Use a simple read operation to determine if IndexedDB recovered.
                // Ideally, we would expose a health check directly on SimpleDb, but
                // RemoteStore only has access to persistence through LocalStore.
                i = function() {
                    return Ko(t.localStore);
                }), 
                    ...
                    return n(o, void 0, void 0, (function() {
                        return r(this, (function(e) {
                            switch (e.label) {
                              ...
                              case 1:
                                return e.sent(), t.Ko.delete(1 /* IndexedDbFailed */), [ 4 /*yield*/ , Ms(t) ];
...
function Xs(t) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                e = W(t), n = uu(e), i = e.Uo.length > 0 ? e.Uo[e.Uo.length - 1].batchId : -1, r.label = 1;
 ...
 */ (e)) return [ 3 /*break*/ , 7 ];
              ...
              case 2:
                return r.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , Qo(e.localStore, i) ];

              case 3:
                return null === (o = r.sent()) ? (0 === e.Uo.length && n.ho(), [ 3 /*break*/ , 7 ]) : (i = o.batchId, 
                function(t, e) {
                    t.Uo.push(e);
                    var n = uu(t);
...
function $s(t) {
    return Gs(t) && !uu(t).oo() && t.Uo.length > 0;
}
...
function eu(t) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            ...
            for (e = uu(t), n = 0, i = t.Uo; n < i.length; n++) o = i[n], e.vo(o.mutations);
            return [ 2 /*return*/ ];
        }));
    }));
}
...
function nu(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = t.Uo.shift(), o = pi.from(n, e, i), [ 4 /*yield*/ , Js(t, (function() {
...
function ru(t, e) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(i) {
            switch (i.label) {
              case 0:
                return e && uu(t).bo ? [ 4 /*yield*/ , function(t, e) {
                    return n(this, void 0, void 0, (function() {
                        var n, i;
                        return r(this, (function(r) {
                            switch (r.label) {
                              case 0:
                                return En(i = e.code) && i !== H.ABORTED ? (n = t.Uo.shift(), 
                                // In this case it's also unlikely that the server itself is melting
                                // down -- this was just a bad request so inhibit backoff on the next
                                // restart.
                                uu(t).ao(), [ 4 /*yield*/ , Js(t, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                ...
                n.Ko.add(3 /* CredentialChange */), [ 4 /*yield*/ , Vs(n) ];

              case 1:
                return r.sent(), i && 
                // Don't set the network status to Unknown if we are offline.
                n.Qo.set("Unknown" /* Unknown */), [ 4 /*yield*/ , n.remoteSyncer.handleCredentialChange(e) ];

              case 2:
                return r.sent(), n.Ko.delete(3 /* CredentialChange */), [ 4 /*yield*/ , Ms(n) ];
 ...
 */ function ou(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = W(t), e ? (n.Ko.delete(2 /* IsSecondary */), [ 4 /*yield*/ , Ms(n) ]) : [ 3 /*break*/ , 2 ];

              case 1:
                return r.sent(), [ 3 /*break*/ , 5 ];

              case 2:
                return e ? [ 3 /*break*/ , 4 ] : (n.Ko.add(2 /* IsSecondary */), [ 4 /*yield*/ , Vs(n) ]);

              case 3:
                r.sent(), n.Qo.set("Unknown" /* Unknown */), r.label = 4;
 ...
 */ function su(t) {
    ...
    t.zo = function(t, e, n) {
        var r = W(t);
        return r.No(), new Cs(e, r.eo, r.authCredentials, r.appCheckCredentials, r.O, n);
    }(t.datastore, t.asyncQueue, {
        Pr: zs.bind(null, t),
        vr: Ws.bind(null, t),
        To: Hs.bind(null, t)
    }), t.Go.push((function(i) {
        return n(e, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.zo.ao(), js(t) ? Ks(t) : t.Qo.set("Unknown" /* Unknown */), [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 1 ];

                  case 1:
                    return [ 4 /*yield*/ , t.zo.stop() ];

                  case 2:
                    e.sent(), Qs(t), e.label = 3;
...
function uu(t) {
    ...
    t.Ho = function(t, e, n) {
        var r = W(t);
        return r.No(), new Os(e, r.eo, r.authCredentials, r.appCheckCredentials, r.O, n);
    }(t.datastore, t.asyncQueue, {
        Pr: tu.bind(null, t),
        vr: ru.bind(null, t),
        So: eu.bind(null, t),
        ...
        return n(e, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.Ho.ao(), [ 4 /*yield*/ , Xs(t) ]) : [ 3 /*break*/ , 2 ];
                  ...
                  case 2:
                    return [ 4 /*yield*/ , t.Ho.stop() ];

                  case 3:
                    e.sent(), t.Uo.length > 0 && (U("RemoteStore", "Stopping write stream with " + t.Uo.length + " pending writes"), 
                    t.Uo = []), e.label = 4;
 ...
 */ function cu(t, e) {
    if (B("AsyncQueue", e + ": " + t), si(t)) return new Y(H.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 */ var hu = /** @class */ function() {
    ...
    function t(t) {
        ...
        }, this.keyedMap = Rn(), this.sortedSet = new Nn(this.comparator)
        /**
    ...
    function t() {
        this.Jo = new Nn(Mt.comparator);
    }
    return t.prototype.track = function(t) {
        var e = t.doc.key, n = this.Jo.get(e);
        n ? 
        ...
        // Metadata->Added
        // Removed->Metadata
        G() : this.Jo = this.Jo.insert(e, t);
    }, t.prototype.Yo = function() {
        var t = [];
        return this.Jo.inorderTraversal((function(e, n) {
            t.push(n);
        })), t;
    }, t;
}(), fu = /** @class */ function() {
    ...
    this.queries = new bo((function(t) {
        return Me(t);
    }), Le), this.onlineState = "Unknown" /* Unknown */ , this.Zo = new Set;
};
 ...
 */ function yu(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                if (n = W(t), i = e.query, o = !1, (s = n.queries.get(i)) || (o = !0, s = new du), 
                !o) return [ 3 /*break*/ , 4 ];
                r.label = 1;
              ...
              case 2:
                return u.Xo = r.sent(), [ 3 /*break*/ , 4 ];

              case 3:
                return a = r.sent(), c = cu(a, "Initialization of query '" + Ve(e.query) + "' failed"), 
                [ 2 /*return*/ , void e.onError(c) ];

              case 4:
                return n.queries.set(i, s), s.listeners.push(e), 
                // Run global snapshot listeners if a consistent snapshot has been emitted.
                e.tc(n.onlineState), s.Xo && e.ec(s.Xo) && wu(n), [ 2 /*return*/ ];
            }
        }));
    }));
}
 ...
 */ var bu = /** @class */ function() {
    ...
    return t.prototype.ec = function(t) {
        ...
        var o = !1;
        return this.sc ? this.rc(t) && (this.nc.next(t), o = !0) : this.oc(t, this.onlineState) && (this.cc(t), 
        o = !0), this.ic = t, o;
    }, t.prototype.onError = function(t) {
        this.nc.error(t);
    }, 
    /** Returns whether a snapshot was raised. */ t.prototype.tc = function(t) {
        this.onlineState = t;
        var e = !1;
        ...
        var e = this.ic && this.ic.hasPendingWrites !== t.hasPendingWrites;
        return !(!t.syncStateChanged && !e) && !0 === this.options.includeMetadataChanges;
        // Generally we should have hit one of the cases above, but it's possible
        // to get here if there were only metadata docChanges and they got
        // stripped out.
        }, t.prototype.cc = function(t) {
        t = fu.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache), this.sc = !0, 
        this.nc.next(t);
    }, t;
}(), Iu = /** @class */ function() {
    function t(t, 
    ...
    return t.prototype.ac = function() {
    ...
    t.prototype.js = function(t) {
        return t.metadata.exists ? lr(this.O, t.document, !1) : te.newNoDocument(this.Gs(t.metadata.name), this.Qs(t.metadata.readTime));
    ...
    function t(t, e, n) {
        ...
        this.documents = [], this.progress = Su(t)
        /**
    ...
    return t.prototype.lc = function(t) {
        ...
        for (var e = new Map, n = new Tu(this.O), r = 0, i = t; r < i.length; r++) {
            var o = i[r];
            if (o.metadata.queries) for (var s = n.Gs(o.metadata.name), u = 0, a = o.metadata.queries; u < a.length; u++) {
                var c = a[u], h = (e.get(c) || Vn()).add(s);
                e.set(c, h);
            }
        }
        return e;
    ...
    t.prototype.complete = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return [ 4 /*yield*/ , $o(this.localStore, new Tu(this.O), this.documents, this.hc.id) ];

                  case 1:
                    t = r.sent(), e = this.fc(this.documents), n = 0, i = this.queries, r.label = 2;

                  case 2:
                    return n < i.length ? (o = i[n], [ 4 /*yield*/ , Zo(this.localStore, o, e.get(o.name)) ]) : [ 3 /*break*/ , 5 ];
                  ...
                  case 5:
                    return [ 2 /*return*/ , (this.progress.taskState = "Success", new Ro(Object.assign({}, this.progress), t)) ];
                }
            }));
        }));
    }, t;
 ...
 */ var Nu = function(t) {
    ...
    e) {
        ...
        this.mutatedKeys = Vn(), this.mc = qe(t), this.gc = new hu(this.mc);
    }
    return Object.defineProperty(t.prototype, "yc", {
        /**
    ...
    t.prototype.Ic = function(t, e) {
        var n = this, r = e ? e.Ec : new lu, i = e ? e.gc : this.gc, o = e ? e.mutatedKeys : this.mutatedKeys, s = i, u = !1, a = Ae(this.query) && i.size === this.query.limit ? i.last() : null, c = ke(this.query) && i.size === this.query.limit ? i.first() : null;
        // Drop documents out to meet limit/limitToLast requirement.
        if (t.inorderTraversal((function(t, e) {
            var h = i.get(t), l = Fe(n.query, e) ? e : null, f = !!h && n.mutatedKeys.has(h.key), d = !!l && (l.hasLocalMutations || 
            ...
            h && l ? h.data.isEqual(l.data) ? f !== d && (r.track({
                type: 3 /* Metadata */ ,
                doc: l
            }), p = !0) : n.Tc(h, l) || (r.track({
                type: 2 /* Modified */ ,
                doc: l
            }), p = !0, (a && n.mc(l, a) > 0 || c && n.mc(l, c) < 0) && (
            ...
            o = o.delete(t)));
        })), Ae(this.query) || ke(this.query)) for (;s.size > this.query.limit; ) {
            var h = Ae(this.query) ? s.last() : s.first();
    ...
    t.prototype.applyChanges = function(t, e, n) {
        ...
        o.sort((function(t, e) {
            return function(t, e) {
                ...
                return n(t) - n(e);
            }(t.type, e.type) || r.mc(t.doc, e.doc);
        })), this.Ac(n);
        var s = e ? this.Rc() : [], u = 0 === this.wc.size && this.current ? 1 /* Synced */ : 0 /* Local */ , a = u !== this._c;
        return this._c = u, 0 !== o.length || a ? {
            snapshot: new fu(this.query, t.gc, i, o, t.mutatedKeys, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            Pc: s
        } : {
            Pc: s
    ...
    t.prototype.Ac = function(t) {
        ...
        // updating many documents.
                var e = this.wc;
        this.wc = Vn(), this.gc.forEach((function(e) {
            t.bc(e.key) && (t.wc = t.wc.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.wc.has(e) || n.push(new _u(e));
        })), this.wc.forEach((function(t) {
            e.has(t) || n.push(new Nu(t));
        })), n;
    }, 
    /**
    ...
    t.prototype.vc = function(t) {
        this.dc = t.Ks, this.wc = Vn();
        var e = this.Ic(t.documents);
    ...
    t.prototype.Vc = function() {
        return fu.fromInitialDocuments(this.query, this.gc, this.mutatedKeys, 0 /* Local */ === this._c);
    }, t;
}(), ku = function(
/**
     * The query itself.
...
n) {
    ...
    r, i, o) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = o, this.Dc = {}, this.Cc = new bo((function(t) {
            return Me(t);
        }), Le), this.Nc = new Map, 
        /**
        ...
        /**
             ...
             * active target.
             */
        this.kc = new Nn(Mt.comparator), 
        /**
             * Keeps track of the information about an active limbo resolution for each
             * active target ID that was started for the purpose of limbo resolution.
             */
        this.Oc = new Map, this.Mc = new ns, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.$c = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.Fc = new Map, this.Bc = uo.Je(), this.onlineState = "Unknown" /* Unknown */ , 
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                ...
                i = s.targetId, n.sharedClientState.addLocalQueryTarget(i), o = s.view.Vc(), [ 3 /*break*/ , 4 ]) : [ 3 /*break*/ , 1 ];

              case 1:
                return [ 4 /*yield*/ , zo(n.localStore, Pe(e)) ];

              case 2:
                return u = r.sent(), n.isPrimaryClient && Fs(n.remoteStore, u), a = n.sharedClientState.addLocalQueryTarget(u.targetId), 
                i = u.targetId, [ 4 /*yield*/ , Ou(n, e, i, "current" === a) ];
                    ...
                    return function(t, e, i, o) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return n = e.view.Ic(i), n.ks ? [ 4 /*yield*/ , Ho(t.localStore, e.query, 
                                    /* usePreviousResults= */ !1).then((function(t) {
                                        var r = t.documents;
                                        return e.view.Ic(r, n);
                                    })) ] : [ 3 /*break*/ , 2 ];
                                  ...
                                  case 2:
                                    ...
                                    /* updateLimboDocuments= */ t.isPrimaryClient, s), [ 2 /*return*/ , (Qu(t, e.targetId, u.Pc), 
                                    u.snapshot) ];
                                }
                            }));
                        }));
                    }(t, e, i, o);
                }, [ 4 /*yield*/ , Ho(t.localStore, e, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return s = f.sent(), u = new Au(e, s.Ks), a = u.Ic(s.documents), c = Bn.createSynthesizedTargetChangeForCurrentChange(i, o && "Offline" /* Offline */ !== t.onlineState), 
                h = u.applyChanges(a, 
                /* updateLimboDocuments= */ t.isPrimaryClient, c), Qu(t, i, h.Pc), l = new ku(e, i, u), 
                [ 2 /*return*/ , (t.Cc.set(e, l), t.Nc.has(i) ? t.Nc.get(i).push(e) : t.Nc.set(i, [ e ]), 
                h.snapshot) ];
            }
        }));
    }));
...
/** Stops listening to the query. */ function Pu(t, e) {
    return n(this, void 0, void 0, (function() {
        var n, i, o;
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = W(t), i = n.Cc.get(e), (o = n.Nc.get(i.targetId)).length > 1 ? [ 2 /*return*/ , (n.Nc.set(i.targetId, o.filter((function(t) {
                    return !Le(t, e);
                }))), void n.Cc.delete(e)) ] : n.isPrimaryClient ? (
                ...
                /*keepPersistedTargetData=*/ !1).then((function() {
                    n.sharedClientState.clearQueryState(i.targetId), qs(n.remoteStore, i.targetId), 
                    ju(n, i.targetId);
                })).catch(fo) ]) : [ 3 /*break*/ , 3 ];
              ...
              case 3:
                return ju(n, i.targetId), [ 4 /*yield*/ , Wo(n.localStore, i.targetId, 
            ...
            switch (r.label) {
              ...
              case 1:
                return r.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    ...
                    return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                        return r.Us.Es(t, o).next((function(o) {
                            n = o;
                            for (
                            ...
                            var s = [], u = 0, a = e; u < a.length; u++) {
                                var c = a[u], h = hn(c, n.get(c.key));
                                null != h && 
                                // NOTE: The base state should only be applied if there's some
                                // existing document to override, so use a Precondition of
                                // exists=true
                                s.push(new pn(c.key, h, Zt(h.value.mapValue), on.exists(!0)));
                            }
                            return r.gs.addMutationBatch(t, i, s, e);
                        }));
                    })).then((function(t) {
              ...
              case 2:
                return o = r.sent(), n.sharedClientState.addPendingMutation(o.batchId), function(t, e, n) {
                    var r = t.$c[t.currentUser.toKey()];
                    r || (r = new Nn(ct)), r = r.insert(e, n), t.$c[t.currentUser.toKey()] = r;
                }(n, o.batchId, i), [ 4 /*yield*/ , Hu(n, o.changes) ];

              case 3:
                return r.sent(), [ 4 /*yield*/ , Xs(n.remoteStore) ];

              case 4:
                return r.sent(), [ 3 /*break*/ , 6 ];

              case 5:
                return s = r.sent(), u = cu(s, "Failed to persist write"), i.reject(u), [ 3 /*break*/ , 6 ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return r.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , jo(n.localStore, e) ];
              ...
              case 2:
                ...
                e.targetChanges.forEach((function(t, e) {
                    ...
                    t.addedDocuments.size > 0 ? r.Sc = !0 : t.modifiedDocuments.size > 0 ? Q(r.Sc) : t.removedDocuments.size > 0 && (Q(r.Sc), 
                    r.Sc = !1));
                })), [ 4 /*yield*/ , Hu(n, i, e) ];
 ...
 */ function Mu(t, e, n) {
    ...
    // SharedClientState.
        ...
        }(r.eventManager, e), i.length && r.Dc.To(i), r.onlineState = e, r.isPrimaryClient && r.sharedClientState.setOnlineState(e);
    }
}
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                // PORTING NOTE: Multi-tab only.
                return (n = W(t)).sharedClientState.updateQueryState(e, "rejected", i), o = n.Oc.get(e), 
                (s = o && o.key) ? (
                // TODO(b/217189216): This limbo document should ideally have a read time,
                // so that it is picked up by any read-time based scans. The backend,
                // however, does not send a read time for target removals.
                u = (u = new Nn(Mt.comparator)).insert(s, te.newNoDocument(s, dt.min())), a = Vn().add(s), 
                c = new Un(dt.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new kn(ct), u, a), [ 4 /*yield*/ , Lu(n, c) ]) : [ 3 /*break*/ , 2 ];
              ...
              case 1:
                ...
                n.kc = n.kc.remove(s), n.Oc.delete(e), Wu(n), [ 3 /*break*/ , 4 ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return r.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , Bo(n.localStore, e) ];
              ...
              case 2:
                ...
                Ku(n, i, /*error=*/ null), Bu(n, i), n.sharedClientState.updateMutationState(i, "acknowledged"), 
                [ 4 /*yield*/ , Hu(n, o) ];
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return r.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Reject batch", "readwrite-primary", (function(t) {
                        var r;
                        return n.gs.lookupMutationBatch(t, e).next((function(e) {
                            return Q(null !== e), r = e.keys(), n.gs.removeMutationBatch(t, e);
                        })).next((function() {
                            return n.gs.performConsistencyCheck(t);
                        })).next((function() {
                            return n.Us.Es(t, r);
              ...
              case 2:
                ...
                // listen events.
                Ku(n, e, i), Bu(n, e), n.sharedClientState.updateMutationState(e, "rejected", i), 
                [ 4 /*yield*/ , Hu(n, o) ];
 ...
 */ function Uu(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                Gs((n = W(t)).remoteStore) || U("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                r.label = 1;
              ...
              case 1:
                return r.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , function(t) {
                    ...
                    return e.persistence.runTransaction("Get highest unacknowledged batch id", "readonly", (function(t) {
                        return e.gs.getHighestUnacknowledgedBatchId(t);
                    }));
                }(n.localStore) ];

              case 2:
                return -1 === (i = r.sent()) ? [ 2 /*return*/ , void e.resolve() ] : ((o = n.Fc.get(i) || []).push(e), 
                n.Fc.set(i, o), [ 3 /*break*/ , 4 ]);

              case 3:
                return s = r.sent(), u = cu(s, "Initialization of waitForPendingWrites() operation failed"), 
...
function Ku(t, e, n) {
    var r = W(t), i = r.$c[r.currentUser.toKey()];
    // NOTE: Mutations restored from persistence won't have callbacks, so it's
    // okay for there to be no callback for this ID.
    if (i) {
        var o = i.get(e);
        o && (n ? o.reject(n) : o.resolve(), i = i.remove(e)), r.$c[r.currentUser.toKey()] = i;
    }
}

function ju(t, e, n) {
    void 0 === n && (n = null), t.sharedClientState.removeLocalQueryTarget(e);
    for (var r = 0, i = t.Nc.get(e); r < i.length; r++) {
        var o = i[r];
        t.Cc.delete(o), n && t.Dc.qc(o, n);
    }
    t.Nc.delete(e), t.isPrimaryClient && t.Mc.si(e).forEach((function(e) {
        t.Mc.containsKey(e) || 
...
function Gu(t, e) {
    ...
    var n = t.kc.get(e);
    null !== n && (qs(t.remoteStore, n), t.kc = t.kc.remove(e), t.Oc.delete(n), Wu(t));
}

function Qu(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof Nu ? (t.Mc.addReference(o.key, e), zu(t, o)) : o instanceof _u ? (U("SyncEngine", "Document no longer in limbo: " + o.key), 
        t.Mc.removeReference(o.key, e), t.Mc.containsKey(o.key) || 
        // We removed the last reference for this key
        Gu(t, o.key)) : G();
    }
}
...
function zu(t, e) {
    ...
    t.kc.get(n) || t.xc.has(r) || (U("SyncEngine", "New document in limbo: " + n), t.xc.add(r), 
    Wu(t));
}
 ...
 */ function Wu(t) {
    for (;t.xc.size > 0 && t.kc.size < t.maxConcurrentLimboResolutions; ) {
        var e = t.xc.values().next().value;
        t.xc.delete(e);
        var n = new Mt(gt.fromString(e)), r = t.Bc.next();
        t.Oc.set(r, new Du(n)), t.kc = t.kc.insert(n, r), Fs(t.remoteStore, new vi(Pe(_e(n.path)), r, 2 /* LimboResolution */ , st.A));
    }
}
...
function Hu(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(c) {
            switch (c.label) {
              case 0:
                return o = W(t), s = [], u = [], a = [], o.Cc.isEmpty() ? [ 3 /*break*/ , 3 ] : (o.Cc.forEach((function(t, n) {
                    a.push(o.Uc(n, e, i).then((function(t) {
                        if (t) {
                            o.isPrimaryClient && o.sharedClientState.updateQueryState(n.targetId, t.fromCache ? "not-current" : "current"), 
                            s.push(t);
                            var e = Mo.Ss(n.targetId, t);
                            u.push(e);
                        }
                    })));
              ...
              case 1:
                return c.sent(), o.Dc.To(s), [ 4 /*yield*/ , function(t, e) {
                    return n(this, void 0, void 0, (function() {
                        var n, i, o, s, u, a, c, h, l;
                        return r(this, (function(r) {
                            switch (r.label) {
                              case 0:
                                n = W(t), r.label = 1;
                              ...
                              case 1:
                                return r.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(t) {
                                    return ei.forEach(e, (function(e) {
                                        return ei.forEach(e.vs, (function(r) {
                              ...
                              case 4:
                                for (o = 0, s = e; o < s.length; o++) u = s[o], a = u.targetId, u.fromCache || (c = n.Ms.get(a), 
                                h = c.snapshotVersion, l = c.withLastLimboFreeSnapshotVersion(h), 
                                // Advance the last limbo free snapshot version
                                n.Ms = n.Ms.insert(a, l));
                                return [ 2 /*return*/ ];
                            }
                        }));
                    }));
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                ...
                n.sharedClientState.handleUserChange(e, i.removedBatchIds, i.addedBatchIds), [ 4 /*yield*/ , Hu(n, i.qs) ];
...
function Ju(t, e) {
    var n = W(t), r = n.Oc.get(e);
    if (r && r.Sc) return Vn().add(r.key);
    var i = Vn(), o = n.Nc.get(e);
    if (!o) return i;
    for (var s = 0, u = o; s < u.length; s++) {
        var a = u[s], c = n.Cc.get(a);
        i = i.unionWith(c.view.yc);
    }
    return i;
}
 ...
 */ function Xu(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , Ho((n = W(t)).localStore, e.query, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return i = r.sent(), o = e.view.vc(i), [ 2 /*return*/ , (n.isPrimaryClient && Qu(n, e.targetId, o.Pc), 
                o) ];
            }
        }));
    }));
...
function $u(t) {
    return n(this, void 0, void 0, (function() {
        var e;
        return r(this, (function(n) {
            return [ 2 /*return*/ , Jo((e = W(t)).localStore).then((function(t) {
                return Hu(e, t);
            })) ];
        }));
    }));
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Lookup mutation documents", "readonly", (function(t) {
                        return r.Ge(t, e).next((function(e) {
                            return e ? n.Us.Es(t, e) : ei.resolve(null);
                        }));
                    }));
                }((n = W(t)).localStore, e) ];

              case 1:
                return null === (s = r.sent()) ? [ 3 /*break*/ , 6 ] : "pending" !== i ? [ 3 /*break*/ , 3 ] : [ 4 /*yield*/ , Xs(n.remoteStore) ];
              ...
              case 3:
                ...
                // other clients.
                Ku(n, e, o || null), Bu(n, e), function(t, e) {
                    W(W(t).gs).Qe(e);
                }(n.localStore, e)) : G(), r.label = 4;

              case 4:
                return [ 4 /*yield*/ , Hu(n, s) ];
...
function ta(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return sa(n = W(t)), ua(n), !0 !== e || !0 === n.Lc ? [ 3 /*break*/ , 3 ] : (i = n.sharedClientState.getAllActiveQueryTargets(), 
                [ 4 /*yield*/ , ea(n, i.toArray()) ]);

              case 1:
                return o = r.sent(), n.Lc = !0, [ 4 /*yield*/ , ou(n.remoteStore, !0) ];

              case 2:
                for (r.sent(), s = 0, u = o; s < u.length; s++) a = u[s], Fs(n.remoteStore, a);
                return [ 3 /*break*/ , 7 ];

              case 3:
                return !1 !== e || !1 === n.Lc ? [ 3 /*break*/ , 7 ] : (c = [], h = Promise.resolve(), 
                n.Nc.forEach((function(t, e) {
                    n.sharedClientState.isLocalQueryTarget(e) ? c.push(e) : h = h.then((function() {
                        return ju(n, e), Wo(n.localStore, e, 
                        /*keepPersistedTargetData=*/ !0);
                    })), qs(n.remoteStore, e);
                })), [ 4 /*yield*/ , h ]);

              case 4:
                return r.sent(), [ 4 /*yield*/ , ea(n, c) ];
              ...
              case 5:
                ...
                function(t) {
                    var e = W(t);
                    e.Oc.forEach((function(t, n) {
                        qs(e.remoteStore, n);
                    })), e.Mc.ii(), e.Oc = new Map, e.kc = new Nn(Mt.comparator);
                }(n), n.Lc = !1, [ 4 /*yield*/ , ou(n.remoteStore, !1) ];
...
function ea(t, e, i) {
    return n(this, void 0, void 0, (function() {
        var n, i, o, s, u, a, c, h, l, f, d, p, y, v;
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
              ...
              case 1:
                return s < u.length ? (a = u[s], c = void 0, (h = n.Nc.get(a)) && 0 !== h.length ? [ 4 /*yield*/ , zo(n.localStore, Pe(h[0])) ] : [ 3 /*break*/ , 7 ]) : [ 3 /*break*/ , 13 ];
              ...
              case 2:
                ...
                c = r.sent(), l = 0, f = h, r.label = 3;

              case 3:
                return l < f.length ? (d = f[l], p = n.Cc.get(d), [ 4 /*yield*/ , Xu(n, p) ]) : [ 3 /*break*/ , 6 ];
              ...
              case 7:
                return [ 4 /*yield*/ , Yo(n.localStore, a) ];

              case 8:
                return v = r.sent(), [ 4 /*yield*/ , zo(n.localStore, v) ];

              case 9:
                return c = r.sent(), [ 4 /*yield*/ , Ou(n, na(v), a, 
                /*current=*/ !1) ];
...
function ra(t) {
    var e = W(t);
    return W(W(e.localStore).persistence).ds();
}
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                if (!n.Nc.has(e)) return [ 3 /*break*/ , 8 ];
                switch (i) {
                  case "current":
                  case "not-current":
                    return [ 3 /*break*/ , 2 ];
              ...
              case 2:
                return [ 4 /*yield*/ , Jo(n.localStore) ];

              case 3:
                return s = r.sent(), u = Un.createSynthesizedRemoteEventForCurrentChange(e, "current" === i), 
                [ 4 /*yield*/ , Hu(n, s, u) ];
              ...
              case 6:
                return r.sent(), ju(n, e, o), [ 3 /*break*/ , 8 ];
...
/** Adds or removes Watch targets for queries from different tabs. */ function oa(t, e, i) {
    return n(this, void 0, void 0, (function() {
        var n, o, s, u, a, c, h, l, f, d;
        return r(this, (function(p) {
            switch (p.label) {
              case 0:
                if (!(n = sa(t)).Lc) return [ 3 /*break*/ , 10 ];
                o = 0, s = e, p.label = 1;

              case 1:
                return o < s.length ? (u = s[o], n.Nc.has(u) ? (
                // A target might have been added in a previous attempt
                U("SyncEngine", "Adding an already active target " + u), [ 3 /*break*/ , 5 ]) : [ 4 /*yield*/ , Yo(n.localStore, u) ]) : [ 3 /*break*/ , 6 ];

              case 2:
                return a = p.sent(), [ 4 /*yield*/ , zo(n.localStore, a) ];

              case 3:
                return c = p.sent(), [ 4 /*yield*/ , Ou(n, na(a), c.targetId, 
                /*current=*/ !1) ];

              case 4:
                p.sent(), Fs(n.remoteStore, c), p.label = 5;
              ...
              case 6:
                h = function(t) {
                    return r(this, (function(e) {
                        switch (e.label) {
                          case 0:
                            return n.Nc.has(t) ? [ 4 /*yield*/ , Wo(n.localStore, t, 
                            /* keepPersistedTargetData */ !1).then((function() {
                                qs(n.remoteStore, t), ju(n, t);
                            })).catch(fo) ] : [ 3 /*break*/ , 2 ];
              ...
              case 7:
                return l < f.length ? (d = f[l], [ 5 /*yield**/ , h(d) ]) : [ 3 /*break*/ , 10 ];
...
function sa(t) {
    var e = W(t);
    return e.remoteStore.remoteSyncer.applyRemoteEvent = Lu.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = Ju.bind(null, e), 
    e.remoteStore.remoteSyncer.rejectListen = Vu.bind(null, e), e.Dc.To = mu.bind(null, e.eventManager), 
    e.Dc.qc = gu.bind(null, e.eventManager), e;
}

function ua(t) {
    var e = W(t);
    return e.remoteStore.remoteSyncer.applySuccessfulWrite = Fu.bind(null, e), e.remoteStore.remoteSyncer.rejectFailedWrite = qu.bind(null, e), 
    e
    /**
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 4:
                    return i._updateProgress(Su(n)), o = new Eu(n, t.localStore, e.O), [ 4 /*yield*/ , e.Kc() ];

                  case 5:
                    s = r.sent(), r.label = 6;

                  case 6:
                    return s ? [ 4 /*yield*/ , o.lc(s) ] : [ 3 /*break*/ , 10 ];

                  case 7:
                    return (u = r.sent()) && i._updateProgress(u), [ 4 /*yield*/ , e.Kc() ];
                  ...
                  case 11:
                    ...
                    // has newer version.
                    return a = r.sent(), [ 4 /*yield*/ , Hu(t, a.ws, 
                    /* remoteEvent */ void 0) ];
                  ...
                  case 12:
                    ...
                    return r.sent(), [ 4 /*yield*/ , function(t, e) {
                        ...
                        return n.persistence.runTransaction("Save bundle", "readwrite", (function(t) {
                            return n.Kn.saveBundleMetadata(t, e);
                        }));
                    }(t.localStore, n) ];
                  ...
                  case 14:
                    return K("SyncEngine", "Loading bundle failed with " + (c = r.sent())), i._failWith(c), 
                    [ 3 /*break*/ , 15 ];
...
var ca = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.O = ks(t.databaseInfo.databaseId), this.sharedClientState = this.Gc(t), 
                    this.persistence = this.jc(t), [ 4 /*yield*/ , this.persistence.start() ];

                  case 1:
                    return e.sent(), this.gcScheduler = this.Qc(t), this.localStore = this.Wc(t), [ 2 /*return*/ ];
                }
            }));
        }));
        ...
        return qo(this.persistence, new Vo, t.initialUser, this.O);
    }, t.prototype.jc = function(t) {
        return new as(hs.bi, this.O);
    ...
    function i(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).zc = t, i.cacheSizeBytes = n, i.forceOwnership = r, 
    ...
    return t(i, e), i.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 1:
                    return r.sent(), [ 4 /*yield*/ , Xo(this.localStore) ];

                  case 2:
                    return r.sent(), [ 4 /*yield*/ , this.zc.initialize(this, t) ];

                  case 3:
                    // Enqueue writes from a previous session
                    return r.sent(), [ 4 /*yield*/ , ua(this.zc.syncEngine) ];

                  case 4:
                    // Enqueue writes from a previous session
                    return r.sent(), [ 4 /*yield*/ , Xs(this.zc.remoteStore) ];

                  case 5:
                    // NOTE: This will immediately call the listener, so we make sure to
                    // set it after localStore / remoteStore are started.
                    return r.sent(), [ 4 /*yield*/ , this.persistence.Hn((function() {
        ...
        return qo(this.persistence, new Vo, t.initialUser, this.O);
    }, i.prototype.Qc = function(t) {
        var e = this.persistence.referenceDelegate.garbageCollector;
        return new vo(e, t.asyncQueue);
    }, i.prototype.jc = function(t) {
        var e = Po(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey), n = void 0 !== this.cacheSizeBytes ? Zi.withCacheSize(this.cacheSizeBytes) : Zi.DEFAULT;
        return new xo(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, _s(), As(), this.O, this.sharedClientState, !!this.forceOwnership);
    }, i.prototype.Gc = function(t) {
        return new bs;
    }, i;
}(ca), la = /** @class */ function(e) {
    function i(t, n) {
        var r = this;
        return (r = e.call(this, t, n, /* forceOwnership= */ !1) || this).zc = t, r.cacheSizeBytes = n, 
    ...
    return t(i, e), i.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(s) {
                switch (s.label) {
                  ...
                  case 1:
                    return s.sent(), i = this.zc.syncEngine, this.sharedClientState instanceof ws ? (this.sharedClientState.syncEngine = {
                        hr: Zu.bind(null, i),
                        lr: ia.bind(null, i),
                        dr: oa.bind(null, i),
                        ds: ra.bind(null, i),
                  ...
                  case 3:
                    // NOTE: This will immediately call the listener, so we make sure to
                    // set it after localStore / remoteStore are started.
                    return [ 4 /*yield*/ , this.persistence.Hn((function(t) {
                        return n(o, void 0, void 0, (function() {
                            return r(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return [ 4 /*yield*/ , ta(this.zc.syncEngine, t) ];
        ...
        var e = _s();
        if (!ws.Vt(e)) throw new Y(H.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        var n = Po(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey);
        return new ws(e, t.asyncQueue, n, t.clientId, t.initialUser);
    }, i;
}(ha), fa = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t, e) {
                ...
                switch (r.label) {
                  case 0:
                    ...
                    /* startAsPrimary=*/ !t.synchronizeTabs), this.sharedClientState.onlineStateHandler = function(t) {
                        return Mu(n.syncEngine, t, 1 /* SharedClientState */);
                    }, this.remoteStore.remoteSyncer.handleCredentialChange = Yu.bind(null, this.syncEngine), 
                    [ 4 /*yield*/ , ou(this.remoteStore, this.syncEngine.isPrimaryClient) ]);
        ...
        var e, n = ks(t.databaseInfo.databaseId), r = (e = t.databaseInfo, new Ns(e));
        ...
        return e = this.localStore, n = this.datastore, r = t.asyncQueue, i = function(t) {
            return Mu(s.syncEngine, t, 0 /* RemoteStore */);
        }, o = Ts.Vt() ? new Ts : new Is, new Ls(e, n, r, i, o);
    }, t.prototype.createSyncEngine = function(t, e) {
        return function(t, e, n, 
        // PORTING NOTE: Manages state synchronization in multi-tab environments.
        r, i, o, s) {
            var u = new xu(t, e, n, r, i, o);
            return s && (u.Lc = !0), u;
        ...
        return function(t) {
            return n(this, void 0, void 0, (function() {
                ...
                return r(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        return e = W(t), U("RemoteStore", "RemoteStore shutting down."), e.Ko.add(5 /* Shutdown */), 
                        [ 4 /*yield*/ , Vs(e) ];

                      case 1:
                        return n.sent(), e.jo.shutdown(), 
                        // Set the OnlineState to Unknown (rather than Offline) to avoid potentially
                        // triggering spurious listener events with cached data, etc.
                        e.Qo.set("Unknown" /* Unknown */), [ 2 /*return*/ ];
                    }
                }));
            }));
        }(this.remoteStore);
 ...
 */ var pa = /** @class */ function() {
    ...
    t, e) {
        ...
        this.Zc().then((function(t) {
            t && t.ac() ? n.metadata.resolve(t.payload.metadata) : n.metadata.reject(new Error("The first element of the bundle is not a metadata, it is\n             " + JSON.stringify(null == t ? void 0 : t.payload)));
        }), (function(t) {
            ...
            return r(this, (function(t) {
                switch (t.label) {
                  ...
                  case 1:
                    ...
                    return [ 2 /*return*/ , (t.sent(), this.Zc()) ];
                }
            }));
        }));
    }, 
    ...
    t.prototype.Zc = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return [ 4 /*yield*/ , this.tu() ];

                  case 1:
                    return null === (t = r.sent()) ? [ 2 /*return*/ , null ] : (e = this.Xc.decode(t), 
                    n = Number(e), isNaN(n) && this.eu("length string (" + e + ") is not valid number"), 
                    [ 4 /*yield*/ , this.nu(n) ]);

                  case 2:
                    return i = r.sent(), [ 2 /*return*/ , new Iu(JSON.parse(i), t.length + n) ];
                }
            }));
        }));
    }, 
    ...
    t.prototype.tu = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.su() < 0 ? [ 4 /*yield*/ , this.iu() ] : [ 3 /*break*/ , 3 ];
                  ...
                  case 3:
                    ...
                    (t = this.su()) < 0 && this.eu("Reached the end of bundle when a length string is expected."), 
    ...
    t.prototype.nu = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.buffer.length < t ? [ 4 /*yield*/ , this.iu() ] : [ 3 /*break*/ , 3 ];

                  case 1:
                    n.sent() && this.eu("Reached the end of bundle when more is expected."), n.label = 2;
                    ...
                    return [ 4 /*yield*/ , function(t, e) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return n = W(t), i = ar(n.O) + "/documents", o = {
                                        documents: e.map((function(t) {
                                            return ir(n.O, t);
                                        }))
                                    }, [ 4 /*yield*/ , n.Lr("BatchGetDocuments", i, o) ];
                                    ...
                                    return s = r.sent(), u = new Map, s.forEach((function(t) {
                                        var e = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = or(t, e.found.name), r = er(e.found.updateTime), i = new $t({
                                                    mapValue: {
                                                        fields: e.found.fields
                                                    }
                                                });
                                                return te.newFoundDocument(n, r, i);
                                            }(t, e) : "missing" in e ? function(t, e) {
                                                Q(!!e.missing), Q(!!e.readTime);
                                                var n = or(t, e.missing), r = er(e.readTime);
            ...
            return r(this, (function(i) {
                switch (i.label) {
                  case 0:
                    ...
                    t.forEach((function(t, n) {
                        var r = Mt.fromPath(n);
                        e.mutations.push(new In(r, e.precondition(r)));
    ...
    t.prototype.precondition = function(t) {
        ...
        return !this.writtenDocs.has(t.toString()) && e ? on.updateTime(e) : on.none();
    }, 
    /**
    ...
    function t(t, e, n, r) {
        ...
        this.ru = 5, this.ro = new Ds(this.asyncQueue, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.ro.Hr((function() {
            return n(t, void 0, void 0, (function() {
                var t, e, n = this;
                return r(this, (function(r) {
                    return t = new va(this.datastore), (e = this.cu(t)) && e.then((function(e) {
        ...
        var e = this;
        this.ru > 0 && this.au(t) ? (this.ru -= 1, this.asyncQueue.enqueueAndForget((function() {
            return e.ou(), Promise.resolve();
            ...
            return n(t, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 5:
                        return t = r.sent(), n = cu(t, "Failed to shutdown persistence"), e.reject(n), [ 3 /*break*/ , 6 ];
...
function ba(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return t.asyncQueue.verifyOperationInProgress(), [ 4 /*yield*/ , Ia(t) ];
              ...
              case 3:
                ...
                t.setCredentialChangeListener((function(t) {
                    return iu(e.remoteStore, t);
                })), t.setAppCheckTokenChangeListener((function(t, n) {
                    return iu(e.remoteStore, n);
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return e = r.sent(), [ 2 /*return*/ , ((n = e.eventManager).onListen = Cu.bind(null, e.syncEngine), 
                n.onUnlisten = Pu.bind(null, e.syncEngine), n) ];
            }
        }));
    }));
}
 ...
 */
/** Returns a string describing the type / value of the provided input. */ function La(t) {
 ...
 */ var Fa = /** @class */ function() {
    ...
    function t(t, e, n) {
        ...
        this._settingsFrozen = !1, t instanceof Ot ? this._databaseId = t : (this._app = t, 
        this._databaseId = function(t) {
            ...
            return new Ot(t.options.projectId);
        }(t));
    }
 ...
 */
        return t = this, (e = xa.get(t)) && (U("ComponentProvider", "Removing Datastore"), 
 ...
 */ var Ba = /** @class */ function() {
    ...
    return Object.defineProperty(t.prototype, "_path", {
         ...
         */
        get: function() {
            return new ja(this.firestore, this.converter, this._key.path.popLast());
        },
        enumerable: !1,
        configurable: !0
    ...
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, _e(r)) || this)._path = r, 
        /** The type of this Firestore reference. */
        i.type = "collection", i;
    }
 ...
 */ function Ga(t, n) {
    ...
    if (t = I(t), Ca("collection", "path", n), t instanceof qa) {
        var o = gt.fromString.apply(gt, e([ n ], r));
        return Ra(o), new ja(t, /* converter= */ null, o);
    }
    if (!(t instanceof Ba || t instanceof ja)) throw new Y(H.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var s = t._path.child(gt.fromString.apply(gt, e([ n ], r)));
    return Ra(s), new ja(t.firestore, 
    /* converter= */ null, s);
}
 ...
 */ function Qa(t, e) {
    if (t = Ma(t, qa), Ca("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new Y(H.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
    return new Ka(t, 
    /* converter= */ null, 
    /**
...
function za(t, n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (n = at.R()), Ca("doc", "path", n), t instanceof qa) {
        var o = gt.fromString.apply(gt, e([ n ], r));
        return Pa(o), new Ba(t, 
        /* converter= */ null, new Mt(o));
    }
    if (!(t instanceof Ba || t instanceof ja)) throw new Y(H.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var s = t._path.child(gt.fromString.apply(gt, e([ n ], r)));
    return Pa(s), new Ba(t.firestore, t instanceof ja ? t.converter : null, new Mt(s));
}
 ...
 * Firestore database.
 */ function Wa(t, e) {
    return t = I(t), e = I(e), (t instanceof Ba || t instanceof ja) && (e instanceof Ba || e instanceof ja) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
    /**
...
function Ha(t, e) {
    return t = I(t), e = I(e), t instanceof Ka && e instanceof Ka && t.firestore === e.firestore && Le(t._query, e._query) && t.converter === e.converter
    /**
 * @license
 * Copyright 2020 Google LLC
 *
...
var Ya = /** @class */ function() {
    function t() {
        ...
        this.ro = new Ds(this, "async_queue_retry" /* AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.yu = function() {
            var e = As();
            e && U("AsyncQueue", "Visibility state changed to " + e.visibilityState), t.ro.Yr();
        };
        var e = As();
        e && "function" == typeof e.addEventListener && e.addEventListener("visibilitychange", this.yu);
    }
    ...
    t.prototype.enqueueAndForget = function(t) {
        ...
        return this.Iu((function() {
            return e.fu && e.mu ? Promise.resolve() : (t().then(n.resolve, n.reject), n.promise);
        })).then((function() {
            return n.promise;
        }));
    ...
    t.prototype.Eu = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (0 === this.lu.length) return [ 3 /*break*/ , 5 ];
                    n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.lu[0]() ];

                  case 2:
                    return n.sent(), this.lu.shift(), this.ro.reset(), [ 3 /*break*/ , 4 ];

                  case 3:
                    if (!si(t = n.sent())) throw t;
        ...
        var e = this, n = this.hu.then((function() {
            return e.wu = !0, t().catch((function(t) {
                e._u = t, e.wu = !1;
                var n = 
                /**
 ...
 */
        ...
        var i = au.createAndSchedule(this, t, e, n, (function(t) {
            return r.Tu(t);
        }));
    ...
    t.prototype.Ru = function(t) {
        for (var e = 0, n = this.du; e < n.length; e++) {
    ...
    t.prototype.Pu = function(t) {
        ...
        // Note that draining may generate more delayed ops, so we do that first.
                return this.Au().then((function() {
            // Run ops in the same order they'd run if they ran naturally.
            e.du.sort((function(t, e) {
                return t.targetTimeMs - e.targetTimeMs;
            }));
            for (var n = 0, r = e.du; n < r.length; n++) {
                var i = r[n];
    ...
    /** Called once a DelayedOperation is run or canceled. */ t.prototype.Tu = function(t) {
        // NOTE: indexOf / slice are O(n), but delayedOperations is expected to be small.
        var e = this.du.indexOf(t);
        this.du.splice(e, 1);
    }, t;
}();
...
var Xa = /** @class */ function() {
    ...
    function n(t, n, r) {
        ...
        /**
             ...
             */
        return (i = e.call(this, t, n, r) || this).type = "firestore", i._queue = new Ya, 
    ...
    return t(n, e), n.prototype._terminate = function() {
        ...
        rc(this), this._firestoreClient.terminate();
    }, n;
}(qa);
 ...
 * @internal
 */ function nc(t) {
    return t._firestoreClient || rc(t), t._firestoreClient.verifyNotTerminated(), t._firestoreClient;
}

function rc(t) {
    var e, n = t._freezeSettings(), r = function(t, e, n, r) {
        return new Ct(t, e, n, r.host, r.ssl, r.experimentalForceLongPolling, r.experimentalAutoDetectLongPolling, r.useFetchStreams);
    }(t._databaseId, (null === (e = t._app) || void 0 === e ? void 0 : e.options.appId) || "", t._persistenceKey, n);
    t._firestoreClient = new ga(t._authCredentials, t._appCheckCredentials, t._queue, r);
}
 ...
 */ function ic(t, e) {
    pc(t = Ma(t, Za));
    var n = nc(t), r = t._freezeSettings(), i = new fa;
    return sc(n, i, new ha(i, r.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
 ...
 */ function oc(t) {
    pc(t = Ma(t, Za));
    var e = nc(t), n = t._freezeSettings(), r = new fa;
    return sc(e, r, new la(r, n.cacheSizeBytes));
}
    ...
    return t.asyncQueue.enqueue((function() {
        return n(o, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return r.trys.push([ 0, 3, , 4 ]), [ 4 /*yield*/ , wa(t, i) ];

                  case 1:
                    return r.sent(), [ 4 /*yield*/ , ba(t, e) ];
            ...
            return r(this, (function(o) {
                switch (o.label) {
                  case 0:
                    return o.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , function(t) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return ri.Vt() ? (e = t + "main", [ 4 /*yield*/ , ri.delete(e) ]) : [ 2 /*return*/ , Promise.resolve() ];
                    ...
                    }(Po(t._databaseId, t._persistenceKey)) ];
 ...
 */ function cc(t) {
            ...
            return n(e, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 1:
                        return e = r.sent(), [ 4 /*yield*/ , Na(t) ];

                      case 2:
                        return n = r.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!0), function(t) {
                            var e = W(t);
                            return e.Ko.delete(0 /* UserDisabled */), Ms(e);
                        }(n)) ];
                    }
                }));
            }));
    ...
    /** Disables the network connection. Pending operations will not complete. */ (nc(t = Ma(t, Za)));
}
                        ...
                        return i = o.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!1), function(t) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = W(t)).Ko.add(0 /* UserDisabled */), [ 4 /*yield*/ , Vs(e) ];

                                      case 1:
                                        return n.sent(), 
                                        // Set the OnlineState to Offline so get()s return from cache, etc.
                                        e.Qo.set("Offline" /* Offline */), [ 2 /*return*/ ];
                                    }
                                }));
                            }));
                        }(i)) ];
...
function dc(t, e) {
    ...
    }(nc(t = Ma(t, Za)), e).then((function(e) {
        return e ? new Ka(t, null, e.query) : null;
    }));
}
...
}(), bc = /^__.*__$/, Ic = /** @class */ function() {
    function t(t, e, n) {
        this.data = t, this.fieldMask = e, this.fieldTransforms = n;
    }
    return t.prototype.toMutation = function(t, e) {
        return null !== this.fieldMask ? new pn(t, this.data, this.fieldMask, e, this.fieldTransforms) : new dn(t, this.data, e, this.fieldTransforms);
    }, t;
}(), Tc = /** @class */ function() {
    function t(t, 
...
/** A "context" object passed around while parsing user data. */ var Sc = /** @class */ function() {
    /**
     ...
     */
    function t(t, e, n, r, i, o) {
        this.settings = t, this.databaseId = e, this.O = n, this.ignoreUndefinedProperties = r, 
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Su = function(e) {
        return new t(Object.assign(Object.assign({}, this.settings), e), this.databaseId, this.O, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
        ...
        return Gc(t, this.settings.methodName, this.settings.Mu || !1, this.path, this.settings.$u);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        // within arrays.
        if (this.path) for (var t = 0; t < this.path.length; t++) this.Nu(this.path.get(t));
    }, t.prototype.Nu = function(t) {
        if (0 === t.length) throw this.Ou("Document fields must not be empty");
        if (Ec(this.Vu) && bc.test(t)) throw this.Ou('Document fields cannot begin and end with "__"');
    }, t;
}(), Nc = /** @class */ function() {
    function t(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.O = n || ks(t)
        /** Creates a new top-level parse context. */;
    }
    return t.prototype.Fu = function(t, e, n, r) {
        return void 0 === r && (r = !1), new Sc({
            Vu: t,
            methodName: e,
            $u: n,
            path: bt.emptyPath(),
 ...
 * classes.
 */ function _c(t) {
    var e = t._freezeSettings(), n = ks(t._databaseId);
    return new Nc(t._databaseId, !!e.ignoreUndefinedProperties, n);
}

/** Parse document data from a set() call. */ function Ac(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var s = t.Fu(o.merge || o.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
...
var xc = /** @class */ function(e) {
    ...
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        return new nn(t.path, new He);
    }, n.prototype.isEqual = function(t) {
        return t instanceof n;
    }, n;
}(gc), Cc = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
...
}(gc), Pc = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t) || this).Lu = n, r;
    }
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = new Ze(t.O, je(t.O, this.Lu));
...
/** Parse update data from an update() call. */ function Rc(t, e, n, r) {
    var i = t.Fu(1 /* Update */ , e, n);
    ...
    var u = new It(o);
    return new Tc(s, u, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function Lc(t, e, n, r, i, o) {
    var s = t.Fu(1 /* Update */ , e, n), u = [ Bc(e, r, n) ], a = [ i ];
    ...
    for (var c = 0; c < o.length; c += 2) u.push(Bc(e, o[c])), a.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var h = [], l = $t.empty(), f = u.length - 1; f >= 0; --f) if (!Qc(h, u[f])) {
        var d = u[f], p = a[f];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        p = I(p);
        ...
        h.push(d); else {
            var v = Vc(p, y);
            null != v && (h.push(d), l.set(d, v));
        }
    }
    var m = new It(h);
    return new Tc(l, m, s.fieldTransforms);
}
 ...
 */ function Mc(t, e, n, r) {
    return void 0 === r && (r = !1), Vc(n, t.Fu(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Vc(t, e) {
    ...
    // from firestore-exp.
    t = I(t))) return Uc("Unsupported field value:", e, t), Fc(t, e);
    if (t instanceof gc) 
    ...
    return function(t, e) {
        ...
        if (!Ec(e.Vu)) throw e.Ou(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        if ("number" == typeof t) return je(e.O, t);
        ...
        if (t instanceof mc) return {
            bytesValue: Zn(e.O, t._byteString)
        };
        if (t instanceof Ba) {
            var i = e.databaseId, o = t.firestore._databaseId;
            if (!o.isEqual(i)) throw e.Ou("Document reference is for database " + o.projectId + "/" + o.database + " but should be for database " + i.projectId + "/" + i.database);
            return {
                referenceValue: nr(t.firestore._databaseId || e.databaseId, t._key.path)
            };
        }
        throw e.Ou("Unsupported field value: " + La(t));
    }(t, e);
}
...
function qc(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof ft || t instanceof wc || t instanceof mc || t instanceof Ba || t instanceof gc);
}
...
function Uc(t, e, n) {
    if (!qc(n) || !function(t) {
        ...
        var r = La(n);
        throw "an object" === r ? e.Ou(t + " a custom object") : e.Ou(t + " " + r);
    }
}
 ...
 */ function Bc(t, e, n) {
    ...
    // FieldPath.
    (e = I(e)) instanceof yc) return e._internalPath;
    if ("string" == typeof e) return jc(t, e);
    throw Gc("Field path arguments must be of type string or ", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 * evaluated.
 */ function jc(t, n, r) {
    if (n.search(Kc) >= 0) throw Gc("Invalid field path (" + n + "). Paths must not contain '~', '*', '/', '[', or ']'", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, r);
    try {
        return (new (yc.bind.apply(yc, e([ void 0 ], n.split(".")))))._internalPath;
    } catch (e) {
        throw Gc("Invalid field path (" + n + "). Paths must not be empty, begin with '.', end with '.', or contain '..'", t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, r);
    }
}
 ...
 */
function Hc(t, e) {
    return "string" == typeof e ? jc(t, e) : e instanceof yc ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ var Yc = /** @class */ function() {
    ...
    n.prototype.data = function(t) {
        if (void 0 === t && (t = {}), this._document) {
            if (this._converter) {
                // We only want to use the converter and create a new DocumentSnapshot
                // if a converter has been provided.
                var e = new Xc(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, 
                /* converter= */ null);
    ...
    t.prototype.forEach = function(t, e) {
        ...
        this._snapshot.docs.forEach((function(r) {
            t.call(e, new Xc(n._firestore, n._userDataWriter, r.key, r, new Yc(n._snapshot.mutatedKeys.has(r.key), n._snapshot.fromCache), n.query.converter));
        }));
    }, 
    /**
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((function(e) {
                    return {
                        type: "added",
                        doc: new Xc(t._firestore, t._userDataWriter, e.doc.key, e.doc, new Yc(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter),
                        oldIndex: -1,
                        newIndex: n++
                    };
                }));
            ...
            return t._snapshot.docChanges.filter((function(t) {
                ...
                var n = new Xc(t._firestore, t._userDataWriter, e.doc.key, e.doc, new Yc(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter), i = -1, o = -1;
...
var ih = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).Uu = t, i.qu = n, i.Ku = r, i.type = "where", 
        i;
    }
    return t(n, e), n.prototype._apply = function(t) {
        var e = _c(t.firestore), n = function(t, e, n, r, i, o, s) {
            var u;
            if (i.isKeyField()) {
            ...
            } else "in" /* IN */ !== o && "not-in" /* NOT_IN */ !== o && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== o || wh(s, o), 
            u = Mc(n, "where", s, 
            /* allowArrays= */ "in" /* IN */ === o || "not-in" /* NOT_IN */ === o);
            var f = he.create(i, o, u);
            return function(t, e) {
                if (e.S()) {
                    var n = xe(t);
 ...
 */
        ...
        }(t._query, 0, e, t.firestore._databaseId, this.Uu, this.qu, this.Ku);
        return new Ka(t.firestore, t.converter, function(t, e) {
...
var sh = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).Uu = t, r.Gu = n, r.type = "orderBy", r;
    }
    return t(n, e), n.prototype._apply = function(t) {
...
var ah = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).type = t, i.ju = n, i.Qu = r, i;
    }
    return t(n, e), n.prototype._apply = function(t) {
        return new Ka(t.firestore, t.converter, Re(t._query, this.ju, this.Qu));
    }, n;
}(nh);
 ...
 * @returns The created {@link Query}.
 */ function ch(t) {
    return Va("limit", t), new ah("limit", t, "F" /* First */)
    /**
...
function hh(t) {
    return Va("limitToLast", t), new ah("limitToLast", t, "L" /* Last */);
}

var lh = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).type = t, i.Wu = n, i.zu = r, i;
    }
    return t(n, e), n.prototype._apply = function(t) {
        var e = mh(t, this.type, this.Wu, this.zu);
        return new Ka(t.firestore, t.converter, function(t, e) {
...
function yh() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new ph("endBefore", t, 
    /*inclusive=*/ !1);
}

function vh() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new ph("endAt", t, /*inclusive=*/ !0);
}

/** Helper function to create a bound from a document or fields */ function mh(t, e, n, r) {
    if (n[0] = I(n[0]), n[0] instanceof zc) return function(t, e, n, r, i) {
        ...
        // results.
        for (var o = [], s = 0, u = Oe(t); s < u.length; s++) {
            var a = u[s];
            if (a.field.isKeyField()) o.push(Qt(e, r.key)); else {
                var c = r.data.field(a.field);
                if (kt(c)) throw new Y(H.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + a.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
    ...
    return function(t, e, n, r, i, o) {
        ...
        for (var u = [], a = 0; a < i.length; a++) {
            ...
            if (s[a].field.isKeyField()) {
                ...
                if (!Ce(t) && -1 !== c.indexOf("/")) throw new Y(H.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                var h = t.path.child(gt.fromString(c));
                if (!Mt.isDocumentKey(h)) throw new Y(H.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by documentId(), the value passed to " + r + "() must result in a valid document path, but '" + h + "' is not because it contains an odd number of segments.");
                var l = new Mt(h);
                u.push(Qt(e, l));
            } else {
                var f = Mc(n, r, c);
...
function gh(t, e, n) {
    if ("string" == typeof (n = I(n))) {
        ...
        if (!Ce(e) && -1 !== n.indexOf("/")) throw new Y(H.INVALID_ARGUMENT, "Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        ...
        return Qt(t, new Mt(r));
    }
    if (n instanceof Ba) return Qt(t, n._key);
    throw new Y(H.INVALID_ARGUMENT, "Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: " + La(n) + ".");
}
 ...
 */ var Ih = /** @class */ function() {
    ...
    return t.prototype.convertValue = function(t, e) {
        ...
        return new wc(_t(t.latitude), _t(t.longitude));
        ...
        Q(Nr(n));
        var r = new Ot(n.get(1), n.get(3)), i = new Mt(n.popFirst(5));
        return r.isEqual(e) || 
...
var Eh = /** @class */ function(e) {
    ...
    return t.prototype.set = function(t, e, n) {
        ...
        var r = Nh(t, this._firestore), i = Th(r.converter, e, n), o = Ac(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
        return this._mutations.push(o.toMutation(r._key, on.none())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
        this._verifyNotCommitted();
        var o, s = Nh(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = I(e)) || e instanceof yc ? Lc(this._dataReader, "WriteBatch.update", s._key, e, n, r) : Rc(this._dataReader, "WriteBatch.update", s._key, e), 
        this._mutations.push(o.toMutation(s._key, on.exists(!0))), this;
    }, 
    /**
    ...
    t.prototype.delete = function(t) {
        this._verifyNotCommitted();
        var e = Nh(t, this._firestore);
        return this._mutations = this._mutations.concat(new bn(e._key, on.none())), this;
    }, 
    /**
 ...
 */ function _h(t) {
    t = Ma(t, Ba);
    var e = Ma(t.firestore, Za);
    return ka(nc(e), t._key).then((function(n) {
        return Uh(e, t, n);
    }));
}
 ...
 */ function kh(t) {
    t = Ma(t, Ba);
    var e = Ma(t.firestore, Za), i = nc(e), o = new Ah(e);
    return function(t, e) {
        var i = this, o = new J;
        return t.asyncQueue.enqueueAndForget((function() {
            return n(i, void 0, void 0, (function() {
                            ...
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(r) {
                                    switch (r.label) {
                                      ...
                                      case 2:
                                        return o = r.sent(), s = cu(o, "Failed to get document '" + e + " from cache"), 
        ...
        return new Jc(e, o, t._key, n, new Yc(null !== n && n.hasLocalMutations, 
 ...
 */ function xh(t) {
    t = Ma(t, Ka);
    var e = Ma(t.firestore, Za), n = nc(e), r = new Ah(e);
    return eh(t._query), Da(n, t._query).then((function(n) {
                        ...
                        return i = function(t, e, i) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(r) {
                                    switch (r.label) {
                                      case 0:
                                        return r.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , Ho(t, e, 
                                        /* usePreviousResults= */ !0) ];

                                      case 1:
                                        return n = r.sent(), o = new Au(e, n.Ks), s = o.Ic(n.documents), u = o.applyChanges(s, 
                                        /* updateLimboDocuments= */ !1), i.resolve(u.snapshot), [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return a = r.sent(), c = cu(a, "Failed to execute query '" + e + " against cache"), 
...
function Ph(t, e, n) {
    t = Ma(t, Ba);
    var r = Ma(t.firestore, Za), i = Th(t.converter, e, n);
    return qh(r, [ Ac(_c(r), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, on.none()) ]);
}

function Rh(t, e, n) {
    for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
    t = Ma(t, Ba);
    var o = Ma(t.firestore, Za), s = _c(o);
    return qh(o, [ ("string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = I(e)) || e instanceof yc ? Lc(s, "updateDoc", t._key, e, n, r) : Rc(s, "updateDoc", t._key, e)).toMutation(t._key, on.exists(!0)) ]);
}
 ...
 */ function Lh(t) {
    return qh(Ma(t.firestore, Za), [ new bn(t._key, on.none()) ]);
}
 ...
 */ function Mh(t, e) {
    var n = Ma(t.firestore, Za), r = za(t), i = Th(t.converter, e);
    return qh(n, [ Ac(_c(t.firestore), "addDoc", r._key, i, null !== t.converter, {}).toMutation(r._key, on.exists(!1)) ]).then((function() {
        return r;
    }));
}
...
function Vh(t) {
    ...
    "object" != typeof s[c] || Ja(s[c]) || (a = s[c], c++);
    var h, l, f, d = {
    ...
    if (t instanceof Ba) l = Ma(t.firestore, Za), f = _e(t._key.path), h = {
        next: function(e) {
            s[c] && s[c](Uh(l, t, e));
        },
        error: s[c + 1],
        ...
        var y = Ma(t, Ka);
        l = Ma(y.firestore, Za), f = y._query;
        var v = new Ah(l);
        h = {
            next: function(t) {
                s[c] && s[c](new $c(l, v, y, t));
            },
            error: s[c + 1],
            complete: s[c + 2]
        }, eh(t._query);
    ...
    return function(t, e, i, o) {
        var s = this, u = new pa(o), a = new bu(e, u, i);
        return t.asyncQueue.enqueueAndForget((function() {
            return n(s, void 0, void 0, (function() {
                var e;
                return r(this, (function(n) {
            ...
            u.Jc(), t.asyncQueue.enqueueAndForget((function() {
                return n(s, void 0, void 0, (function() {
                    var e;
                    return r(this, (function(n) {
                        switch (n.label) {
                          case 0:
                            return e = vu, [ 4 /*yield*/ , Aa(t) ];
...
function Fh(t, e) {
    return function(t, e) {
        ...
        return t.asyncQueue.enqueueAndForget((function() {
            ...
            o.Jc(), t.asyncQueue.enqueueAndForget((function() {
                return n(i, void 0, void 0, (function() {
                    var e;
                    return r(this, (function(n) {
                        switch (n.label) {
 ...
 */ function Uh(t, e, n) {
    var r = n.docs.get(e._key), i = new Ah(t);
    return new Jc(t, i, e._key, r, new Yc(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 */ var Bh, Kh = /** @class */ function(e) {
     ...
     */    return t(n, e), n.prototype.get = function(t) {
        var n = this, r = Nh(t, this._firestore), i = new Ah(this._firestore);
        return e.prototype.get.call(this, t).then((function(t) {
            return new Jc(n._firestore, i, r._key, t._document, new Yc(
            /* hasPendingWrites= */ !1, 
    ...
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._transaction = e, this._dataReader = _c(t)
        /**
     * Reads the document referenced by the provided {@link DocumentReference}.
     *
     * @param documentRef - A reference to the document to be read.
    ...
    return t.prototype.get = function(t) {
        var e = this, n = Nh(t, this._firestore), r = new Eh(this._firestore);
        return this._transaction.lookup([ n._key ]).then((function(t) {
            if (!t || 1 !== t.length) return G();
            var i = t[0];
            if (i.isFoundDocument()) return new zc(e._firestore, r, i.key, i, n.converter);
            if (i.isNoDocument()) return new zc(e._firestore, r, n._key, null, n.converter);
            throw G();
        }));
    }, t.prototype.set = function(t, e, n) {
        var r = Nh(t, this._firestore), i = Th(r.converter, e, n), o = Ac(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = I(e)) || e instanceof yc ? Lc(this._dataReader, "Transaction.update", s._key, e, n, r) : Rc(this._dataReader, "Transaction.update", s._key, e), 
            ...
            return n(i, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 1:
                        return n = r.sent(), new ma(t.asyncQueue, n, e, o).run(), [ 2 /*return*/ ];
                    }
                }));
            }));
        })), o.promise;
    }(nc(t = Ma(t, Za)), (function(n) {
        return e(new Kh(t, n));
    }));
}
 ...
 * writes.
 */ function Yh(t) {
    return nc(t = Ma(t, Za)), new Sh(t, (function(e) {
        return qh(t, e);
    }))
    /**
 * @license
...
function Jh(t, e) {
    ...
    // persistence since `enableIndexeddbPersistence()` can fail on the Web.
        ...
        var s = o[i], u = Xh(s, "collectionGroup"), a = [];
        if (Array.isArray(s.fields)) for (var c = 0, h = s.fields; c < h.length; c++) {
            var l = h[c], f = jc("setIndexConfiguration", Xh(l, "fieldPath"));
            "CONTAINS" === l.arrayConfig ? a.push(new ne(f, 2 /* CONTAINS */)) : "ASCENDING" === l.order ? a.push(new ne(f, 0 /* ASCENDING */)) : "DESCENDING" === l.order && a.push(new ne(f, 1 /* DESCENDING */));
        }
        r.push(new ee(ee.UNKNOWN_ID, u, a, re.empty()));
    }
 ...
 */ void 0 === Bh && (Bh = !0), M = i, o(new c("firestore", (function(t, e) {
    var n = e.options, r = t.getProvider("app").getImmediate(), i = new Za(r, new tt(t.getProvider("auth-internal")), new it(t.getProvider("app-check-internal")));
    return n = Object.assign({
        useFetchStreams: Bh
    }, n), i._setSettings(n), i;
}), "PUBLIC")), s(R, "3.4.5", void 0), 
// BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
s(R, "3.4.5", "esm5");

export { Ih as AbstractUserDataWriter, mc as Bytes, $a as CACHE_SIZE_UNLIMITED, ja as CollectionReference, Ba as DocumentReference, Jc as DocumentSnapshot, yc as FieldPath, gc as FieldValue, Za as Firestore, Y as FirestoreError, wc as GeoPoint, Xa as LoadBundleTask, Ka as Query, nh as QueryConstraint, Xc as QueryDocumentSnapshot, $c as QuerySnapshot, Yc as SnapshotMetadata, ft as Timestamp, Kh as Transaction, Sh as WriteBatch, Ot as _DatabaseId, Mt as _DocumentKey, ot as _EmptyAppCheckTokenProvider, $ as _EmptyAuthCredentialsProvider, bt as _FieldPath, Ma as _cast, z as _debugAssert, Tt as _isBase64Available, K as _logWarn, Jh as _setIndexConfiguration, Oa as _validateIsNotUsedTogether, Mh as addDoc, Wh as arrayRemove, zh as arrayUnion, uc as clearIndexedDbPersistence, Ga as collection, Qa as collectionGroup, Ua as connectFirestoreEmulator, Lh as deleteDoc, Gh as deleteField, hc as disableNetwork, za as doc, vc as documentId, ic as enableIndexedDbPersistence, oc as enableMultiTabIndexedDbPersistence, cc as enableNetwork, vh as endAt, yh as endBefore, nc as ensureFirestoreConfigured, qh as executeWrite, _h as getDoc, kh as getDocFromCache, Dh as getDocFromServer, xh as getDocs, Ch as getDocsFromCache, Oh as getDocsFromServer, ec as getFirestore, Hh as increment, tc as initializeFirestore, ch as limit, hh as limitToLast, fc as loadBundle, dc as namedQuery, Vh as onSnapshot, Fh as onSnapshotsInSync, uh as orderBy, rh as query, Ha as queryEqual, Wa as refEqual, jh as runTransaction, Qh as serverTimestamp, Ph as setDoc, q as setLogLevel, th as snapshotEqual, dh as startAfter, fh as startAt, lc as terminate, Rh as updateDoc, ac as waitForPendingWrites, oh as where, Yh as writeBatch };
